...
function asPromise(s, n) {
    for (var o = new Array(arguments.length - 1), t = 0, e = 2, i = !0; e < arguments.length; ) o[t++] = arguments[e++];
    return new Promise(
        /* @__PURE__ */ r(function (c, l) {
...
(function (s) {
    ...
    n.length = /* @__PURE__ */ r(function (c) {
        var l = c.length;
        if (!l) return 0;
        for (var a = 0; --l % 4 > 1 && c.charAt(l) === '='; ) ++a;
...
EventEmitter.prototype.off = /* @__PURE__ */ r(function (n, o) {
    ...
    else for (var t = this._listeners[n], e = 0; e < t.length; ) t[e].fn === o ? t.splice(e, 1) : ++e;
    return this;
}, 'off');
EventEmitter.prototype.emit = /* @__PURE__ */ r(function (n) {
    var o = this._listeners[n];
    if (o) {
        for (var t = [], e = 1; e < arguments.length; ) t.push(arguments[e++]);
        for (e = 0; e < o.length; ) o[e].fn.apply(o[e++].ctx, t);
    }
    return this;
}, 'emit');
        ...
        typeof Float32Array < 'u'
            ...
            : (function () {
                  function n(t, e, i, u) {
                      ...
                      else if (isNaN(e)) t(2143289344, i, u);
                      else if (e > 34028234663852886e22) t(((c << 31) | 2139095040) >>> 0, i, u);
                      else if (e < 11754943508222875e-54)
                          t(((c << 31) | Math.round(e / 1401298464324817e-60)) >>> 0, i, u);
                      else {
                          var l = Math.floor(Math.log(e) / Math.LN2),
                              a = Math.round(e * Math.pow(2, -l) * 8388608) & 8388607;
                          t(((c << 31) | ((l + 127) << 23) | a) >>> 0, i, u);
                      }
                  }
                  r(n, 'writeFloat_ieee754'),
                      (s.writeFloatLE = n.bind(null, writeUintLE)),
                      (s.writeFloatBE = n.bind(null, writeUintBE));
                  function o(t, e, i) {
                      var u = t(e, i),
                          c = (u >> 31) * 2 + 1,
                          l = (u >>> 23) & 255,
                      ...
                      return l === 255
                          ? a
                              ...
                              : c * (1 / 0)
                          : l === 0
                            ? c * 1401298464324817e-60 * a
                            : c * Math.pow(2, l - 150) * (a + 8388608);
                  }
                  r(o, 'readFloat_ieee754'),
                      (s.readFloatLE = o.bind(null, readUintLE)),
                      (s.readFloatBE = o.bind(null, readUintBE));
              })(),
        typeof Float64Array < 'u'
            ...
            : (function () {
                  function n(t, e, i, u, c, l) {
                      ...
                      if ((a && (u = -u), u === 0))
                      ...
                      else if (isNaN(u)) t(0, c, l + e), t(2146959360, c, l + i);
                      else if (u > 17976931348623157e292) t(0, c, l + e), t(((a << 31) | 2146435072) >>> 0, c, l + i);
                      else {
                          var f;
                          if (u < 22250738585072014e-324)
                              ...
                              p === 1024 && (p = 1023),
                                  (f = u * Math.pow(2, -p)),
                                  t((f * 4503599627370496) >>> 0, c, l + e),
                                  t(((a << 31) | ((p + 1023) << 20) | ((f * 1048576) & 1048575)) >>> 0, c, l + i);
                          }
                      }
                  }
                  r(n, 'writeDouble_ieee754'),
                      (s.writeDoubleLE = n.bind(null, writeUintLE, 0, 4)),
                      (s.writeDoubleBE = n.bind(null, writeUintBE, 4, 0));
                  function o(t, e, i, u, c) {
                      var l = t(u, c + e),
                          a = t(u, c + i),
                          f = (a >> 31) * 2 + 1,
                          p = (a >>> 20) & 2047,
                          d = 4294967296 * (a & 1048575) + l;
                      return p === 2047
                          ? d
                              ? NaN
                              : f * (1 / 0)
                  ...
                  r(o, 'readDouble_ieee754'),
                      (s.readDoubleLE = o.bind(null, readUintLE, 0, 4)),
                      (s.readDoubleBE = o.bind(null, readUintBE, 4, 0));
              })(),
        s
    );
}
...
function inquire(moduleName) {
    try {
        // Avoid use of eval by calling require directly if available
        var mod;
        if (typeof require === 'function') {
            mod = require(moduleName);
        } else if (typeof commonjsGlobal.require === 'function') {
            mod = commonjsGlobal.require(moduleName);
        }
        ...
        for (var e = 0, i = 0, u = 0; u < t.length; ++u)
            (i = t.charCodeAt(u)),
                i < 128
                    ...
                    : i < 2048
                      ? (e += 2)
                      : (i & 64512) === 55296 && (t.charCodeAt(u + 1) & 64512) === 56320
                        ? (++u, (e += 4))
                        : (e += 3);
        return e;
    }, 'utf8_length')),
        (n.read = /* @__PURE__ */ r(function (t, e, i) {
            var u = i - e;
            if (u < 1) return '';
                ...
                (f = t[e++]),
                    f < 128
                        ...
                        : f > 191 && f < 224
                          ...
                          : f > 239 && f < 365
                            ? ((f =
                                  (((f & 7) << 18) | ((t[e++] & 63) << 12) | ((t[e++] & 63) << 6) | (t[e++] & 63)) -
                                  65536),
                              (l[a++] = 55296 + (f >> 10)),
                              (l[a++] = 56320 + (f & 1023)))
                            : (l[a++] = ((f & 15) << 12) | ((t[e++] & 63) << 6) | (t[e++] & 63)),
                    a > 8191 && ((c || (c = [])).push(String.fromCharCode.apply(String, l)), (a = 0));
            return c
                ? (a && c.push(String.fromCharCode.apply(String, l.slice(0, a))), c.join(''))
                : String.fromCharCode.apply(String, l.slice(0, a));
        }, 'utf8_read')),
        (n.write = /* @__PURE__ */ r(function (t, e, i) {
            for (var u = i, c, l, a = 0; a < t.length; ++a)
                (c = t.charCodeAt(a)),
                    c < 128
                        ? (e[i++] = c)
                        : c < 2048
                          ? ((e[i++] = (c >> 6) | 192), (e[i++] = (c & 63) | 128))
                          : (c & 64512) === 55296 && ((l = t.charCodeAt(a + 1)) & 64512) === 56320
                            ? ((c = 65536 + ((c & 1023) << 10) + (l & 1023)),
                              ...
                              (e[i++] = ((c >> 6) & 63) | 128),
                              (e[i++] = (c & 63) | 128))
                            : ((e[i++] = (c >> 12) | 224), (e[i++] = ((c >> 6) & 63) | 128), (e[i++] = (c & 63) | 128));
            return i - u;
        }, 'utf8_write'));
})(utf8$2);
var pool_1 = pool;
...
function requireLongbits() {
    ...
    (n.fromNumber = /* @__PURE__ */ r(function (u) {
        ...
        var l = u >>> 0,
            a = ((u - l) / 4294967296) >>> 0;
        return (
            c && ((a = ~a >>> 0), (l = ~l >>> 0), ++l > 4294967295 && ((l = 0), ++a > 4294967295 && (a = 0))),
            new n(l, a)
        );
    }, 'fromNumber')),
        (n.from = /* @__PURE__ */ r(function (u) {
            if (typeof u == 'number') return n.fromNumber(u);
            if (s.isString(u))
                if (s.Long) u = s.Long.fromString(u);
                else return n.fromNumber(parseInt(u, 10));
            return u.low || u.high ? new n(u.low >>> 0, u.high >>> 0) : o;
        }, 'from')),
        (n.prototype.toNumber = /* @__PURE__ */ r(function (u) {
            if (!u && this.hi >>> 31) {
                var c = (~this.lo + 1) >>> 0,
                    l = ~this.hi >>> 0;
        ...
        (n.prototype.toLong = /* @__PURE__ */ r(function (u) {
            return s.Long
                ? new s.Long(this.lo | 0, this.hi | 0, !!u)
                : {low: this.lo | 0, high: this.hi | 0, unsigned: !!u};
        }, 'toLong'));
    var e = String.prototype.charCodeAt;
    return (
        (n.fromHash = /* @__PURE__ */ r(function (u) {
            return u === t
                ? o
                : new n(
        ...
        (n.prototype.toHash = /* @__PURE__ */ r(function () {
        ...
        (n.prototype.zzEncode = /* @__PURE__ */ r(function () {
            var u = this.hi >> 31;
            return (
                (this.hi = (((this.hi << 1) | (this.lo >>> 31)) ^ u) >>> 0),
                (this.lo = ((this.lo << 1) ^ u) >>> 0),
                this
            );
        }, 'zzEncode')),
        (n.prototype.zzDecode = /* @__PURE__ */ r(function () {
            var u = -(this.lo & 1);
            return (
                (this.lo = (((this.lo >>> 1) | (this.hi << 31)) ^ u) >>> 0),
                (this.hi = ((this.hi >>> 1) ^ u) >>> 0),
                this
            );
        }, 'zzDecode')),
        (n.prototype.length = /* @__PURE__ */ r(function () {
            var u = this.lo,
        ...
        hasRequiredMinimal ||
            ...
            (function (s) {
                ...
                (n.asPromise = aspromise),
                    ...
                    (n.global =
                        (n.isNode && commonjsGlobal) ||
                        (typeof window < 'u' && window) ||
                        (typeof self < 'u' && self) ||
                        commonjsGlobal),
                    (n.emptyArray = Object.freeze
                        ? Object.freeze([])
                        : /* istanbul ignore next */
                          []),
                    (n.emptyObject = Object.freeze
                        ? Object.freeze({})
                        : /* istanbul ignore next */
                          {}),
                    (n.isInteger =
                    ...
                    (n.isString = /* @__PURE__ */ r(function (i) {
                        return typeof i == 'string' || i instanceof String;
                    }, 'isString')),
                    (n.isObject = /* @__PURE__ */ r(function (i) {
                    ...
                    (n.isset =
                         ...
                         */
                        n.isSet =
                            /* @__PURE__ */ r(function (i, u) {
                                var c = i[u];
                                return c != null && i.hasOwnProperty(u)
                                    ? typeof c != 'object' || (Array.isArray(c) ? c.length : Object.keys(c).length) > 0
                                    : !1;
                            }, 'isSet')),
                    (n.Buffer = (function () {
                        try {
                            var e = n.inquire('buffer').Buffer;
                            return e.prototype.utf8Write
                                ? e
                                : /* istanbul ignore next */
                                  null;
                        } catch {
                    ...
                    (n.newBuffer = /* @__PURE__ */ r(function (i) {
                        return typeof i == 'number'
                            ? n.Buffer
                                ? n._Buffer_allocUnsafe(i)
                                : new n.Array(i)
                            : n.Buffer
                              ? n._Buffer_from(i)
                              : typeof Uint8Array > 'u'
                    ...
                    (n.longToHash = /* @__PURE__ */ r(function (i) {
                        return i ? n.LongBits.from(i).toHash() : n.LongBits.zeroHash;
                    }, 'longToHash')),
                    (n.longFromHash = /* @__PURE__ */ r(function (i, u) {
                ...
                r(o, 'merge'),
                    (n.merge = o),
                    (n.lcFirst = /* @__PURE__ */ r(function (i) {
                        return i.charAt(0).toLowerCase() + i.substring(1);
                    }, 'lcFirst'));
                function t(e) {
                    function i(u, c) {
                        if (!(this instanceof i)) return new i(u, c);
                ...
                r(t, 'newError'),
                    (n.newError = t),
                    (n.ProtocolError = t('ProtocolError')),
                    (n.oneOfGetter = /* @__PURE__ */ r(function (i) {
                        for (var u = {}, c = 0; c < i.length; ++c) u[i[c]] = 1;
                        return function () {
                            for (var l = Object.keys(this), a = l.length - 1; a > -1; --a)
                                if (u[l[a]] === 1 && this[l[a]] !== void 0 && this[l[a]] !== null) return l[a];
                        };
                    }, 'getOneOf')),
                    (n.oneOfSetter = /* @__PURE__ */ r(function (i) {
                        return function (u) {
                            for (var c = 0; c < i.length; ++c) i[c] !== u && delete this[i[c]];
                        };
                    }, 'setOneOf')),
                    (n.toJSONOptions = {
                        longs: String,
                    ...
                    (n._configure = function () {
                        ...
                        (n._Buffer_from =
                            (e.from !== Uint8Array.from && e.from) /* istanbul ignore next */ ||
                            /* @__PURE__ */ r(function (u, c) {
                                return new e(u, c);
                            }, 'Buffer_from')),
                            (n._Buffer_allocUnsafe =
                                e.allocUnsafe /* istanbul ignore next */ ||
...
Writer$1.prototype.uint32 = /* @__PURE__ */ r(function s(n) {
    return (
        (this.len += (this.tail = this.tail.next =
            new VarintOp((n = n >>> 0) < 128 ? 1 : n < 16384 ? 2 : n < 2097152 ? 3 : n < 268435456 ? 4 : 5, n)).len),
        this
    );
}, 'write_uint32');
...
function writeVarint64(s, n, o) {
    for (; s.hi; ) (n[o++] = (s.lo & 127) | 128), (s.lo = ((s.lo >>> 7) | (s.hi << 25)) >>> 0), (s.hi >>>= 7);
    for (; s.lo > 127; ) (n[o++] = (s.lo & 127) | 128), (s.lo = s.lo >>> 7);
    n[o++] = s.lo;
}
...
var writeBytes = util$4.Array.prototype.set
    ? /* @__PURE__ */ r(function s(n, o, t) {
          o.set(n, t);
      }, 'writeBytes_set')
    : /* @__PURE__ */ r(function s(n, o, t) {
          for (var e = 0; e < n.length; ++e) o[t + e] = n[e];
      }, 'writeBytes_for');
Writer$1.prototype.bytes = /* @__PURE__ */ r(function s(n) {
    var o = n.length >>> 0;
    if (!o) return this._push(writeByte, 1, 0);
    ...
    (BufferWriter.alloc = util$3._Buffer_allocUnsafe),
        (BufferWriter.writeBytesBuffer =
            util$3.Buffer && util$3.Buffer.prototype instanceof Uint8Array && util$3.Buffer.prototype.set.name === 'set'
                ? /* @__PURE__ */ r(function (n, o, t) {
                      o.set(n, t);
                  }, 'writeBytesBuffer_set')
                : /* @__PURE__ */ r(function (n, o, t) {
                      if (n.copy) n.copy(o, t, 0, n.length);
                      else for (var e = 0; e < n.length; ) o[t++] = n[e++];
...
var create_array =
        typeof Uint8Array < 'u'
            ? /* @__PURE__ */ r(function s(n) {
                  if (n instanceof Uint8Array || Array.isArray(n)) return new Reader$1(n);
                  throw Error('illegal buffer');
              }, 'create_typed_array')
            : /* @__PURE__ */ r(function s(n) {
                  if (Array.isArray(n)) return new Reader$1(n);
                  throw Error('illegal buffer');
              }, 'create_array'),
    create = /* @__PURE__ */ r(function s() {
        return util$2.Buffer
            ? /* @__PURE__ */ r(function (o) {
    ...
    return /* @__PURE__ */ r(function () {
        if (
            ...
            this.buf[this.pos++] < 128 ||
                ((n = (n | ((this.buf[this.pos] & 127) << 7)) >>> 0), this.buf[this.pos++] < 128) ||
                ((n = (n | ((this.buf[this.pos] & 127) << 14)) >>> 0), this.buf[this.pos++] < 128) ||
                ((n = (n | ((this.buf[this.pos] & 127) << 21)) >>> 0), this.buf[this.pos++] < 128) ||
                ((n = (n | ((this.buf[this.pos] & 15) << 28)) >>> 0), this.buf[this.pos++] < 128))
        )
            return n;
...
function readLongVarint() {
    var s = new LongBits(0, 0),
        n = 0;
    if (this.len - this.pos > 4) {
        for (; n < 4; ++n)
            if (((s.lo = (s.lo | ((this.buf[this.pos] & 127) << (n * 7))) >>> 0), this.buf[this.pos++] < 128)) return s;
        if (
            ((s.lo = (s.lo | ((this.buf[this.pos] & 127) << 28)) >>> 0),
            (s.hi = (s.hi | ((this.buf[this.pos] & 127) >> 4)) >>> 0),
            this.buf[this.pos++] < 128)
        )
            return s;
        n = 0;
...
Reader$1.prototype.bytes = /* @__PURE__ */ r(function s() {
    var n = this.uint32(),
        o = this.pos,
        t = this.pos + n;
    if (t > this.len) throw indexOutOfRange(this, n);
    return (
        (this.pos += n),
...
Reader$1.prototype.skip = /* @__PURE__ */ r(function s(n) {
    if (typeof n == 'number') {
        if (this.pos + n > this.len) throw indexOutOfRange(this, n);
        this.pos += n;
    } else
...
Reader$1.prototype.skipType = function (s) {
    switch (s) {
        ...
        case 2:
            ...
            break;
        case 3:
            for (; (s = this.uint32() & 7) !== 4; ) this.skipType(s);
            break;
        case 5:
            this.skip(4);
            break;
...
BufferReader.prototype.string = /* @__PURE__ */ r(function s() {
    ...
    return this.buf.utf8Slice
        ? this.buf.utf8Slice(this.pos, (this.pos = Math.min(this.pos + n, this.len)))
        : this.buf.toString('utf-8', this.pos, (this.pos = Math.min(this.pos + n, this.len)));
}, 'read_string_buffer');
...
Service.prototype.rpcCall = /* @__PURE__ */ r(function s(n, o, t, e, i) {
    ...
    var u = this;
    if (!i) return util.asPromise(s, u, n, o, t, e);
    if (!u.rpcImpl) {
        setTimeout(function () {
    ...
    try {
        return u.rpcImpl(
            ...
            /* @__PURE__ */ r(function (l, a) {
                if (l) return u.emit('error', l, n), i(l);
                if (a === null) {
                    u.end(
                        /* endedByRPC */
                        !0
...
const $Reader = minimal.Reader,
    ...
    $util = minimal.util,
    $root = minimal.roots.default || (minimal.roots.default = {});
$root.PB_App = (() => {
    const s = {};
    return (
        (s.StartRequest = (function () {
            function n(o) {
                if (o) for (let t = Object.keys(o), e = 0; e < t.length; ++e) o[t[e]] != null && (this[t[e]] = o[t[e]]);
            }
            return (
                r(n, 'StartRequest'),
                (n.prototype.name = ''),
                (n.prototype.args = ''),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.name != null && Object.hasOwnProperty.call(t, 'name') && e.uint32(10).string(t.name),
                        t.args != null && Object.hasOwnProperty.call(t, 'args') && e.uint32(18).string(t.args),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                    return this.encode(t, e).ldelim();
                }, 'encodeDelimited')),
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.StartRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.decodeDelimited = /* @__PURE__ */ r(function (t) {
                    return t instanceof $Reader || (t = new $Reader(t)), this.decode(t, t.uint32());
                }, 'decodeDelimited')),
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.name != null && t.hasOwnProperty('name') && !$util.isString(t.name)
                          ? 'name: string expected'
                          : t.args != null && t.hasOwnProperty('args') && !$util.isString(t.args)
                            ? 'args: string expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.StartRequest) return t;
                    const e = new $root.PB_App.StartRequest();
                    return t.name != null && (e.name = String(t.name)), t.args != null && (e.args = String(t.args)), e;
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    e || (e = {});
                    const i = {};
                    return (
                        e.defaults && ((i.name = ''), (i.args = '')),
                        t.name != null && t.hasOwnProperty('name') && (i.name = t.name),
                        t.args != null && t.hasOwnProperty('args') && (i.args = t.args),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.LockStatusRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.LockStatusRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
                    return this.constructor.toObject(this, minimal.util.toJSONOptions);
        ...
        (s.LockStatusResponse = (function () {
            ...
            return (
                r(n, 'LockStatusResponse'),
                (n.prototype.locked = !1),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.locked != null && Object.hasOwnProperty.call(t, 'locked') && e.uint32(8).bool(t.locked),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.LockStatusResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.locked != null && t.hasOwnProperty('locked') && typeof t.locked != 'boolean'
                          ? 'locked: boolean expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.LockStatusResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.locked = !1),
                        t.locked != null && t.hasOwnProperty('locked') && (i.locked = t.locked),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.AppExitRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.AppExitRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
        ...
        (s.AppLoadFileRequest = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.path != null && Object.hasOwnProperty.call(t, 'path') && e.uint32(10).string(t.path),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.AppLoadFileRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.path != null && t.hasOwnProperty('path') && !$util.isString(t.path)
                          ? 'path: string expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.AppLoadFileRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.path = ''), t.path != null && t.hasOwnProperty('path') && (i.path = t.path), i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
                    return this.constructor.toObject(this, minimal.util.toJSONOptions);
        ...
        (s.AppButtonPressRequest = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.args != null && Object.hasOwnProperty.call(t, 'args') && e.uint32(10).string(t.args),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.AppButtonPressRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.AppButtonPressRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.args = ''), t.args != null && t.hasOwnProperty('args') && (i.args = t.args), i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
                    return this.constructor.toObject(this, minimal.util.toJSONOptions);
        ...
        (s.AppButtonReleaseRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.AppButtonReleaseRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_App.AppButtonReleaseRequest
                        ? t
                        : new $root.PB_App.AppButtonReleaseRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.AppStateResponse = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.AppStateResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.AppStateResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.state = e.enums === String ? 'APP_CLOSED' : 0),
                        t.state != null &&
                            t.hasOwnProperty('state') &&
                            (i.state = e.enums === String ? $root.PB_App.AppState[t.state] : t.state),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.GetErrorRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.GetErrorRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
        ...
        (s.GetErrorResponse = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.code != null && Object.hasOwnProperty.call(t, 'code') && e.uint32(8).uint32(t.code),
                        t.text != null && Object.hasOwnProperty.call(t, 'text') && e.uint32(18).string(t.text),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.GetErrorResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.code != null && t.hasOwnProperty('code') && !$util.isInteger(t.code)
                          ? 'code: integer expected'
                          : t.text != null && t.hasOwnProperty('text') && !$util.isString(t.text)
                            ? 'text: string expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.GetErrorResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && ((i.code = 0), (i.text = '')),
                        t.code != null && t.hasOwnProperty('code') && (i.code = t.code),
                        t.text != null && t.hasOwnProperty('text') && (i.text = t.text),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.DataExchangeRequest = (function () {
            ...
            return (
                r(n, 'DataExchangeRequest'),
                (n.prototype.data = $util.newBuffer([])),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.data != null && Object.hasOwnProperty.call(t, 'data') && e.uint32(10).bytes(t.data),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_App.DataExchangeRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ...
                        : t.data != null &&
                            ...
                            !((t.data && typeof t.data.length == 'number') || $util.isString(t.data))
                          ? 'data: buffer expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_App.DataExchangeRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        e.defaults &&
                            (e.bytes === String
                                ? (i.data = '')
                                : ((i.data = []), e.bytes !== Array && (i.data = $util.newBuffer(i.data)))),
                        t.data != null &&
                            t.hasOwnProperty('data') &&
                            (i.data =
                                e.bytes === String
                                    ? $util.base64.encode(t.data, 0, t.data.length)
                                    : e.bytes === Array
...
const PB = ($root.PB = (() => {
    const s = {};
    return (
        (s.CommandStatus = (function () {
            const n = {},
                o = Object.create(n);
            return (
                (o[(n[0] = 'OK')] = 0),
                (o[(n[1] = 'ERROR')] = 1),
                (o[(n[2] = 'ERROR_DECODE')] = 2),
                (o[(n[3] = 'ERROR_NOT_IMPLEMENTED')] = 3),
                (o[(n[4] = 'ERROR_BUSY')] = 4),
                (o[(n[14] = 'ERROR_CONTINUOUS_COMMAND_INTERRUPTED')] = 14),
                (o[(n[15] = 'ERROR_INVALID_PARAMETERS')] = 15),
                (o[(n[5] = 'ERROR_STORAGE_NOT_READY')] = 5),
                (o[(n[6] = 'ERROR_STORAGE_EXIST')] = 6),
                (o[(n[7] = 'ERROR_STORAGE_NOT_EXIST')] = 7),
                (o[(n[8] = 'ERROR_STORAGE_INVALID_PARAMETER')] = 8),
                (o[(n[9] = 'ERROR_STORAGE_DENIED')] = 9),
                (o[(n[10] = 'ERROR_STORAGE_INVALID_NAME')] = 10),
                (o[(n[11] = 'ERROR_STORAGE_INTERNAL')] = 11),
                (o[(n[12] = 'ERROR_STORAGE_NOT_IMPLEMENTED')] = 12),
                (o[(n[13] = 'ERROR_STORAGE_ALREADY_OPEN')] = 13),
                (o[(n[18] = 'ERROR_STORAGE_DIR_NOT_EMPTY')] = 18),
                (o[(n[16] = 'ERROR_APP_CANT_START')] = 16),
                (o[(n[17] = 'ERROR_APP_SYSTEM_LOCKED')] = 17),
                (o[(n[21] = 'ERROR_APP_NOT_RUNNING')] = 21),
                (o[(n[22] = 'ERROR_APP_CMD_ERROR')] = 22),
                (o[(n[19] = 'ERROR_VIRTUAL_DISPLAY_ALREADY_STARTED')] = 19),
                (o[(n[20] = 'ERROR_VIRTUAL_DISPLAY_NOT_STARTED')] = 20),
                (o[(n[58] = 'ERROR_GPIO_MODE_INCORRECT')] = 58),
                (o[(n[59] = 'ERROR_GPIO_UNKNOWN_PIN_MODE')] = 59),
                o
            );
        })()),
        (s.Empty = (function () {
        ...
        (s.Main = (function () {
            function n(t) {
                if (t) for (let e = Object.keys(t), i = 0; i < e.length; ++i) t[e[i]] != null && (this[e[i]] = t[e[i]]);
            }
            r(n, 'Main'),
                (n.prototype.commandId = 0),
                (n.prototype.commandStatus = 0),
                (n.prototype.hasNext = !1),
                (n.prototype.empty = null),
                (n.prototype.stopSession = null),
                (n.prototype.systemPingRequest = null),
                (n.prototype.systemPingResponse = null),
                (n.prototype.systemRebootRequest = null),
                (n.prototype.systemDeviceInfoRequest = null),
                (n.prototype.systemDeviceInfoResponse = null),
                (n.prototype.systemFactoryResetRequest = null),
                (n.prototype.systemGetDatetimeRequest = null),
                (n.prototype.systemGetDatetimeResponse = null),
                (n.prototype.systemSetDatetimeRequest = null),
                (n.prototype.systemPlayAudiovisualAlertRequest = null),
                (n.prototype.systemProtobufVersionRequest = null),
                (n.prototype.systemProtobufVersionResponse = null),
                (n.prototype.systemUpdateRequest = null),
                (n.prototype.systemUpdateResponse = null),
                (n.prototype.systemPowerInfoRequest = null),
                (n.prototype.systemPowerInfoResponse = null),
                (n.prototype.storageInfoRequest = null),
                (n.prototype.storageInfoResponse = null),
                (n.prototype.storageTimestampRequest = null),
                (n.prototype.storageTimestampResponse = null),
                (n.prototype.storageStatRequest = null),
                (n.prototype.storageStatResponse = null),
                (n.prototype.storageListRequest = null),
                (n.prototype.storageListResponse = null),
                (n.prototype.storageReadRequest = null),
                (n.prototype.storageReadResponse = null),
                (n.prototype.storageWriteRequest = null),
                (n.prototype.storageDeleteRequest = null),
                (n.prototype.storageMkdirRequest = null),
                (n.prototype.storageMd5sumRequest = null),
                (n.prototype.storageMd5sumResponse = null),
                (n.prototype.storageRenameRequest = null),
                (n.prototype.storageBackupCreateRequest = null),
                (n.prototype.storageBackupRestoreRequest = null),
                (n.prototype.appStartRequest = null),
                (n.prototype.appLockStatusRequest = null),
                (n.prototype.appLockStatusResponse = null),
                (n.prototype.appExitRequest = null),
                (n.prototype.appLoadFileRequest = null),
                (n.prototype.appButtonPressRequest = null),
                (n.prototype.appButtonReleaseRequest = null),
                (n.prototype.appGetErrorRequest = null),
                (n.prototype.appGetErrorResponse = null),
                (n.prototype.appDataExchangeRequest = null),
                (n.prototype.guiStartScreenStreamRequest = null),
                (n.prototype.guiStopScreenStreamRequest = null),
                (n.prototype.guiScreenFrame = null),
                (n.prototype.guiSendInputEventRequest = null),
                (n.prototype.guiStartVirtualDisplayRequest = null),
                (n.prototype.guiStopVirtualDisplayRequest = null),
                (n.prototype.gpioSetPinMode = null),
                (n.prototype.gpioSetInputPull = null),
                (n.prototype.gpioGetPinMode = null),
                (n.prototype.gpioGetPinModeResponse = null),
                (n.prototype.gpioReadPin = null),
                (n.prototype.gpioReadPinResponse = null),
                (n.prototype.gpioWritePin = null),
                (n.prototype.appStateResponse = null),
                (n.prototype.propertyGetRequest = null),
                (n.prototype.propertyGetResponse = null);
            let o;
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (e, i) {
                    return (
                        i || (i = $Writer.create()),
                        e.commandId != null &&
                            Object.hasOwnProperty.call(e, 'commandId') &&
                            i.uint32(8).uint32(e.commandId),
                        e.commandStatus != null &&
                            Object.hasOwnProperty.call(e, 'commandStatus') &&
                            i.uint32(16).int32(e.commandStatus),
                        e.hasNext != null && Object.hasOwnProperty.call(e, 'hasNext') && i.uint32(24).bool(e.hasNext),
                        e.empty != null &&
                            Object.hasOwnProperty.call(e, 'empty') &&
                            $root.PB.Empty.encode(e.empty, i.uint32(34).fork()).ldelim(),
                        e.systemPingRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemPingRequest') &&
                            $root.PB_System.PingRequest.encode(e.systemPingRequest, i.uint32(42).fork()).ldelim(),
                        e.systemPingResponse != null &&
                            Object.hasOwnProperty.call(e, 'systemPingResponse') &&
                            $root.PB_System.PingResponse.encode(e.systemPingResponse, i.uint32(50).fork()).ldelim(),
                        e.storageListRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageListRequest') &&
                            $root.PB_Storage.ListRequest.encode(e.storageListRequest, i.uint32(58).fork()).ldelim(),
                        e.storageListResponse != null &&
                            Object.hasOwnProperty.call(e, 'storageListResponse') &&
                            $root.PB_Storage.ListResponse.encode(e.storageListResponse, i.uint32(66).fork()).ldelim(),
                        e.storageReadRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageReadRequest') &&
                            $root.PB_Storage.ReadRequest.encode(e.storageReadRequest, i.uint32(74).fork()).ldelim(),
                        e.storageReadResponse != null &&
                            Object.hasOwnProperty.call(e, 'storageReadResponse') &&
                            $root.PB_Storage.ReadResponse.encode(e.storageReadResponse, i.uint32(82).fork()).ldelim(),
                        e.storageWriteRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageWriteRequest') &&
                            $root.PB_Storage.WriteRequest.encode(e.storageWriteRequest, i.uint32(90).fork()).ldelim(),
                        e.storageDeleteRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageDeleteRequest') &&
                            $root.PB_Storage.DeleteRequest.encode(e.storageDeleteRequest, i.uint32(98).fork()).ldelim(),
                        e.storageMkdirRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageMkdirRequest') &&
                            $root.PB_Storage.MkdirRequest.encode(e.storageMkdirRequest, i.uint32(106).fork()).ldelim(),
                        e.storageMd5sumRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageMd5sumRequest') &&
                            $root.PB_Storage.Md5sumRequest.encode(
                                e.storageMd5sumRequest,
                                i.uint32(114).fork()
                            ).ldelim(),
                        e.storageMd5sumResponse != null &&
                            Object.hasOwnProperty.call(e, 'storageMd5sumResponse') &&
                            $root.PB_Storage.Md5sumResponse.encode(
                                e.storageMd5sumResponse,
                                i.uint32(122).fork()
                            ).ldelim(),
                        e.appStartRequest != null &&
                            Object.hasOwnProperty.call(e, 'appStartRequest') &&
                            $root.PB_App.StartRequest.encode(e.appStartRequest, i.uint32(130).fork()).ldelim(),
                        e.appLockStatusRequest != null &&
                            Object.hasOwnProperty.call(e, 'appLockStatusRequest') &&
                            $root.PB_App.LockStatusRequest.encode(
                                e.appLockStatusRequest,
                                i.uint32(138).fork()
                            ).ldelim(),
                        e.appLockStatusResponse != null &&
                            Object.hasOwnProperty.call(e, 'appLockStatusResponse') &&
                            $root.PB_App.LockStatusResponse.encode(
                                e.appLockStatusResponse,
                                i.uint32(146).fork()
                            ).ldelim(),
                        e.stopSession != null &&
                            Object.hasOwnProperty.call(e, 'stopSession') &&
                            $root.PB.StopSession.encode(e.stopSession, i.uint32(154).fork()).ldelim(),
                        e.guiStartScreenStreamRequest != null &&
                            Object.hasOwnProperty.call(e, 'guiStartScreenStreamRequest') &&
                            $root.PB_Gui.StartScreenStreamRequest.encode(
                                e.guiStartScreenStreamRequest,
                                i.uint32(162).fork()
                            ).ldelim(),
                        e.guiStopScreenStreamRequest != null &&
                            Object.hasOwnProperty.call(e, 'guiStopScreenStreamRequest') &&
                            $root.PB_Gui.StopScreenStreamRequest.encode(
                                e.guiStopScreenStreamRequest,
                                i.uint32(170).fork()
                            ).ldelim(),
                        e.guiScreenFrame != null &&
                            Object.hasOwnProperty.call(e, 'guiScreenFrame') &&
                            $root.PB_Gui.ScreenFrame.encode(e.guiScreenFrame, i.uint32(178).fork()).ldelim(),
                        e.guiSendInputEventRequest != null &&
                            Object.hasOwnProperty.call(e, 'guiSendInputEventRequest') &&
                            $root.PB_Gui.SendInputEventRequest.encode(
                                e.guiSendInputEventRequest,
                                i.uint32(186).fork()
                            ).ldelim(),
                        e.storageStatRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageStatRequest') &&
                            $root.PB_Storage.StatRequest.encode(e.storageStatRequest, i.uint32(194).fork()).ldelim(),
                        e.storageStatResponse != null &&
                            Object.hasOwnProperty.call(e, 'storageStatResponse') &&
                            $root.PB_Storage.StatResponse.encode(e.storageStatResponse, i.uint32(202).fork()).ldelim(),
                        e.guiStartVirtualDisplayRequest != null &&
                            Object.hasOwnProperty.call(e, 'guiStartVirtualDisplayRequest') &&
                            $root.PB_Gui.StartVirtualDisplayRequest.encode(
                                e.guiStartVirtualDisplayRequest,
                                i.uint32(210).fork()
                            ).ldelim(),
                        e.guiStopVirtualDisplayRequest != null &&
                            Object.hasOwnProperty.call(e, 'guiStopVirtualDisplayRequest') &&
                            $root.PB_Gui.StopVirtualDisplayRequest.encode(
                                e.guiStopVirtualDisplayRequest,
                                i.uint32(218).fork()
                            ).ldelim(),
                        e.storageInfoRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageInfoRequest') &&
                            $root.PB_Storage.InfoRequest.encode(e.storageInfoRequest, i.uint32(226).fork()).ldelim(),
                        e.storageInfoResponse != null &&
                            Object.hasOwnProperty.call(e, 'storageInfoResponse') &&
                            $root.PB_Storage.InfoResponse.encode(e.storageInfoResponse, i.uint32(234).fork()).ldelim(),
                        e.storageRenameRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageRenameRequest') &&
                            $root.PB_Storage.RenameRequest.encode(
                                e.storageRenameRequest,
                                i.uint32(242).fork()
                            ).ldelim(),
                        e.systemRebootRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemRebootRequest') &&
                            $root.PB_System.RebootRequest.encode(e.systemRebootRequest, i.uint32(250).fork()).ldelim(),
                        e.systemDeviceInfoRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemDeviceInfoRequest') &&
                            $root.PB_System.DeviceInfoRequest.encode(
                                e.systemDeviceInfoRequest,
                                i.uint32(258).fork()
                            ).ldelim(),
                        e.systemDeviceInfoResponse != null &&
                            Object.hasOwnProperty.call(e, 'systemDeviceInfoResponse') &&
                            $root.PB_System.DeviceInfoResponse.encode(
                                e.systemDeviceInfoResponse,
                                i.uint32(266).fork()
                            ).ldelim(),
                        e.systemFactoryResetRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemFactoryResetRequest') &&
                            $root.PB_System.FactoryResetRequest.encode(
                                e.systemFactoryResetRequest,
                                i.uint32(274).fork()
                            ).ldelim(),
                        e.systemGetDatetimeRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemGetDatetimeRequest') &&
                            $root.PB_System.GetDateTimeRequest.encode(
                                e.systemGetDatetimeRequest,
                                i.uint32(282).fork()
                            ).ldelim(),
                        e.systemGetDatetimeResponse != null &&
                            Object.hasOwnProperty.call(e, 'systemGetDatetimeResponse') &&
                            $root.PB_System.GetDateTimeResponse.encode(
                                e.systemGetDatetimeResponse,
                                i.uint32(290).fork()
                            ).ldelim(),
                        e.systemSetDatetimeRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemSetDatetimeRequest') &&
                            $root.PB_System.SetDateTimeRequest.encode(
                                e.systemSetDatetimeRequest,
                                i.uint32(298).fork()
                            ).ldelim(),
                        e.systemPlayAudiovisualAlertRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemPlayAudiovisualAlertRequest') &&
                            $root.PB_System.PlayAudiovisualAlertRequest.encode(
                                e.systemPlayAudiovisualAlertRequest,
                                i.uint32(306).fork()
                            ).ldelim(),
                        e.systemProtobufVersionRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemProtobufVersionRequest') &&
                            $root.PB_System.ProtobufVersionRequest.encode(
                                e.systemProtobufVersionRequest,
                                i.uint32(314).fork()
                            ).ldelim(),
                        e.systemProtobufVersionResponse != null &&
                            Object.hasOwnProperty.call(e, 'systemProtobufVersionResponse') &&
                            $root.PB_System.ProtobufVersionResponse.encode(
                                e.systemProtobufVersionResponse,
                                i.uint32(322).fork()
                            ).ldelim(),
                        e.systemUpdateRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemUpdateRequest') &&
                            $root.PB_System.UpdateRequest.encode(e.systemUpdateRequest, i.uint32(330).fork()).ldelim(),
                        e.storageBackupCreateRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageBackupCreateRequest') &&
                            $root.PB_Storage.BackupCreateRequest.encode(
                                e.storageBackupCreateRequest,
                                i.uint32(338).fork()
                            ).ldelim(),
                        e.storageBackupRestoreRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageBackupRestoreRequest') &&
                            $root.PB_Storage.BackupRestoreRequest.encode(
                                e.storageBackupRestoreRequest,
                                i.uint32(346).fork()
                            ).ldelim(),
                        e.systemPowerInfoRequest != null &&
                            Object.hasOwnProperty.call(e, 'systemPowerInfoRequest') &&
                            $root.PB_System.PowerInfoRequest.encode(
                                e.systemPowerInfoRequest,
                                i.uint32(354).fork()
                            ).ldelim(),
                        e.systemPowerInfoResponse != null &&
                            Object.hasOwnProperty.call(e, 'systemPowerInfoResponse') &&
                            $root.PB_System.PowerInfoResponse.encode(
                                e.systemPowerInfoResponse,
                                i.uint32(362).fork()
                            ).ldelim(),
                        e.systemUpdateResponse != null &&
                            Object.hasOwnProperty.call(e, 'systemUpdateResponse') &&
                            $root.PB_System.UpdateResponse.encode(
                                e.systemUpdateResponse,
                                i.uint32(370).fork()
                            ).ldelim(),
                        e.appExitRequest != null &&
                            Object.hasOwnProperty.call(e, 'appExitRequest') &&
                            $root.PB_App.AppExitRequest.encode(e.appExitRequest, i.uint32(378).fork()).ldelim(),
                        e.appLoadFileRequest != null &&
                            Object.hasOwnProperty.call(e, 'appLoadFileRequest') &&
                            $root.PB_App.AppLoadFileRequest.encode(e.appLoadFileRequest, i.uint32(386).fork()).ldelim(),
                        e.appButtonPressRequest != null &&
                            Object.hasOwnProperty.call(e, 'appButtonPressRequest') &&
                            $root.PB_App.AppButtonPressRequest.encode(
                                e.appButtonPressRequest,
                                i.uint32(394).fork()
                            ).ldelim(),
                        e.appButtonReleaseRequest != null &&
                            Object.hasOwnProperty.call(e, 'appButtonReleaseRequest') &&
                            $root.PB_App.AppButtonReleaseRequest.encode(
                                e.appButtonReleaseRequest,
                                i.uint32(402).fork()
                            ).ldelim(),
                        e.gpioSetPinMode != null &&
                            Object.hasOwnProperty.call(e, 'gpioSetPinMode') &&
                            $root.PB_Gpio.SetPinMode.encode(e.gpioSetPinMode, i.uint32(410).fork()).ldelim(),
                        e.gpioSetInputPull != null &&
                            Object.hasOwnProperty.call(e, 'gpioSetInputPull') &&
                            $root.PB_Gpio.SetInputPull.encode(e.gpioSetInputPull, i.uint32(418).fork()).ldelim(),
                        e.gpioGetPinMode != null &&
                            Object.hasOwnProperty.call(e, 'gpioGetPinMode') &&
                            $root.PB_Gpio.GetPinMode.encode(e.gpioGetPinMode, i.uint32(426).fork()).ldelim(),
                        e.gpioGetPinModeResponse != null &&
                            Object.hasOwnProperty.call(e, 'gpioGetPinModeResponse') &&
                            $root.PB_Gpio.GetPinModeResponse.encode(
                                e.gpioGetPinModeResponse,
                                i.uint32(434).fork()
                            ).ldelim(),
                        e.gpioReadPin != null &&
                            Object.hasOwnProperty.call(e, 'gpioReadPin') &&
                            $root.PB_Gpio.ReadPin.encode(e.gpioReadPin, i.uint32(442).fork()).ldelim(),
                        e.gpioReadPinResponse != null &&
                            Object.hasOwnProperty.call(e, 'gpioReadPinResponse') &&
                            $root.PB_Gpio.ReadPinResponse.encode(e.gpioReadPinResponse, i.uint32(450).fork()).ldelim(),
                        e.gpioWritePin != null &&
                            Object.hasOwnProperty.call(e, 'gpioWritePin') &&
                            $root.PB_Gpio.WritePin.encode(e.gpioWritePin, i.uint32(458).fork()).ldelim(),
                        e.appStateResponse != null &&
                            Object.hasOwnProperty.call(e, 'appStateResponse') &&
                            $root.PB_App.AppStateResponse.encode(e.appStateResponse, i.uint32(466).fork()).ldelim(),
                        e.storageTimestampRequest != null &&
                            Object.hasOwnProperty.call(e, 'storageTimestampRequest') &&
                            $root.PB_Storage.TimestampRequest.encode(
                                e.storageTimestampRequest,
                                i.uint32(474).fork()
                            ).ldelim(),
                        e.storageTimestampResponse != null &&
                            Object.hasOwnProperty.call(e, 'storageTimestampResponse') &&
                            $root.PB_Storage.TimestampResponse.encode(
                                e.storageTimestampResponse,
                                i.uint32(482).fork()
                            ).ldelim(),
                        e.propertyGetRequest != null &&
                            Object.hasOwnProperty.call(e, 'propertyGetRequest') &&
                            $root.PB_Property.GetRequest.encode(e.propertyGetRequest, i.uint32(490).fork()).ldelim(),
                        e.propertyGetResponse != null &&
                            Object.hasOwnProperty.call(e, 'propertyGetResponse') &&
                            $root.PB_Property.GetResponse.encode(e.propertyGetResponse, i.uint32(498).fork()).ldelim(),
                        e.appGetErrorRequest != null &&
                            Object.hasOwnProperty.call(e, 'appGetErrorRequest') &&
                            $root.PB_App.GetErrorRequest.encode(e.appGetErrorRequest, i.uint32(506).fork()).ldelim(),
                        e.appGetErrorResponse != null &&
                            Object.hasOwnProperty.call(e, 'appGetErrorResponse') &&
                            $root.PB_App.GetErrorResponse.encode(e.appGetErrorResponse, i.uint32(514).fork()).ldelim(),
                        e.appDataExchangeRequest != null &&
                            Object.hasOwnProperty.call(e, 'appDataExchangeRequest') &&
                            $root.PB_App.DataExchangeRequest.encode(
                                e.appDataExchangeRequest,
                                i.uint32(522).fork()
                            ).ldelim(),
                        i
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (e, i) {
                    return this.encode(e, i).ldelim();
                }, 'encodeDelimited')),
                (n.decode = /* @__PURE__ */ r(function (e, i) {
                    e instanceof $Reader || (e = $Reader.create(e));
                    const u = i === void 0 ? e.len : e.pos + i,
                        c = new $root.PB.Main();
                    for (; e.pos < u; ) {
                        const l = e.uint32();
                        switch (l >>> 3) {
                            ...
                            case 37:
                                ...
                                break;
                            case 38:
                                c.systemPlayAudiovisualAlertRequest =
                                    $root.PB_System.PlayAudiovisualAlertRequest.decode(e, e.uint32());
                                break;
                            case 39:
                                c.systemProtobufVersionRequest = $root.PB_System.ProtobufVersionRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            case 40:
                                c.systemProtobufVersionResponse = $root.PB_System.ProtobufVersionResponse.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            ...
                            case 30:
                                ...
                                break;
                            case 42:
                                c.storageBackupCreateRequest = $root.PB_Storage.BackupCreateRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            case 43:
                                c.storageBackupRestoreRequest = $root.PB_Storage.BackupRestoreRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            ...
                            case 65:
                                ...
                                break;
                            case 20:
                                c.guiStartScreenStreamRequest = $root.PB_Gui.StartScreenStreamRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            case 21:
                                c.guiStopScreenStreamRequest = $root.PB_Gui.StopScreenStreamRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            ...
                            case 23:
                                ...
                                break;
                            case 26:
                                c.guiStartVirtualDisplayRequest = $root.PB_Gui.StartVirtualDisplayRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                            case 27:
                                c.guiStopVirtualDisplayRequest = $root.PB_Gui.StopVirtualDisplayRequest.decode(
                                    e,
                                    e.uint32()
                                );
                                break;
                ...
                (n.decodeDelimited = /* @__PURE__ */ r(function (e) {
                    return e instanceof $Reader || (e = new $Reader(e)), this.decode(e, e.uint32());
                }, 'decodeDelimited')),
                (n.verify = /* @__PURE__ */ r(function (e) {
                    ...
                    if (e.stopSession != null && e.hasOwnProperty('stopSession')) {
                        if (i.content === 1) return 'content: multiple values';
                        i.content = 1;
                        {
                            const u = $root.PB.StopSession.verify(e.stopSession);
                            if (u) return 'stopSession.' + u;
                        }
                    }
                    if (e.systemPingRequest != null && e.hasOwnProperty('systemPingRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemPingRequest.' + u;
                        }
                    }
                    if (e.systemPingResponse != null && e.hasOwnProperty('systemPingResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemPingResponse.' + u;
                        }
                    }
                    if (e.systemRebootRequest != null && e.hasOwnProperty('systemRebootRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemRebootRequest.' + u;
                        }
                    }
                    if (e.systemDeviceInfoRequest != null && e.hasOwnProperty('systemDeviceInfoRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemDeviceInfoRequest.' + u;
                        }
                    }
                    if (e.systemDeviceInfoResponse != null && e.hasOwnProperty('systemDeviceInfoResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemDeviceInfoResponse.' + u;
                        }
                    }
                    if (e.systemFactoryResetRequest != null && e.hasOwnProperty('systemFactoryResetRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemFactoryResetRequest.' + u;
                        }
                    }
                    if (e.systemGetDatetimeRequest != null && e.hasOwnProperty('systemGetDatetimeRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemGetDatetimeRequest.' + u;
                        }
                    }
                    if (e.systemGetDatetimeResponse != null && e.hasOwnProperty('systemGetDatetimeResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemGetDatetimeResponse.' + u;
                        }
                    }
                    if (e.systemSetDatetimeRequest != null && e.hasOwnProperty('systemSetDatetimeRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemSetDatetimeRequest.' + u;
                        }
                    }
                    if (
                        e.systemPlayAudiovisualAlertRequest != null &&
                        e.hasOwnProperty('systemPlayAudiovisualAlertRequest')
                    ) {
                        if (i.content === 1) return 'content: multiple values';
                        i.content = 1;
                        {
                            const u = $root.PB_System.PlayAudiovisualAlertRequest.verify(
                                e.systemPlayAudiovisualAlertRequest
                            );
                            if (u) return 'systemPlayAudiovisualAlertRequest.' + u;
                        }
                    }
                    if (e.systemProtobufVersionRequest != null && e.hasOwnProperty('systemProtobufVersionRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemProtobufVersionRequest.' + u;
                        }
                    }
                    if (e.systemProtobufVersionResponse != null && e.hasOwnProperty('systemProtobufVersionResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemProtobufVersionResponse.' + u;
                        }
                    }
                    if (e.systemUpdateRequest != null && e.hasOwnProperty('systemUpdateRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemUpdateRequest.' + u;
                        }
                    }
                    if (e.systemUpdateResponse != null && e.hasOwnProperty('systemUpdateResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemUpdateResponse.' + u;
                        }
                    }
                    if (e.systemPowerInfoRequest != null && e.hasOwnProperty('systemPowerInfoRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemPowerInfoRequest.' + u;
                        }
                    }
                    if (e.systemPowerInfoResponse != null && e.hasOwnProperty('systemPowerInfoResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'systemPowerInfoResponse.' + u;
                        }
                    }
                    if (e.storageInfoRequest != null && e.hasOwnProperty('storageInfoRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageInfoRequest.' + u;
                        }
                    }
                    if (e.storageInfoResponse != null && e.hasOwnProperty('storageInfoResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageInfoResponse.' + u;
                        }
                    }
                    if (e.storageTimestampRequest != null && e.hasOwnProperty('storageTimestampRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageTimestampRequest.' + u;
                        }
                    }
                    if (e.storageTimestampResponse != null && e.hasOwnProperty('storageTimestampResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageTimestampResponse.' + u;
                        }
                    }
                    if (e.storageStatRequest != null && e.hasOwnProperty('storageStatRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageStatRequest.' + u;
                        }
                    }
                    if (e.storageStatResponse != null && e.hasOwnProperty('storageStatResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageStatResponse.' + u;
                        }
                    }
                    if (e.storageListRequest != null && e.hasOwnProperty('storageListRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageListRequest.' + u;
                        }
                    }
                    if (e.storageListResponse != null && e.hasOwnProperty('storageListResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageListResponse.' + u;
                        }
                    }
                    if (e.storageReadRequest != null && e.hasOwnProperty('storageReadRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageReadRequest.' + u;
                        }
                    }
                    if (e.storageReadResponse != null && e.hasOwnProperty('storageReadResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageReadResponse.' + u;
                        }
                    }
                    if (e.storageWriteRequest != null && e.hasOwnProperty('storageWriteRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageWriteRequest.' + u;
                        }
                    }
                    if (e.storageDeleteRequest != null && e.hasOwnProperty('storageDeleteRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageDeleteRequest.' + u;
                        }
                    }
                    if (e.storageMkdirRequest != null && e.hasOwnProperty('storageMkdirRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageMkdirRequest.' + u;
                        }
                    }
                    if (e.storageMd5sumRequest != null && e.hasOwnProperty('storageMd5sumRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageMd5sumRequest.' + u;
                        }
                    }
                    if (e.storageMd5sumResponse != null && e.hasOwnProperty('storageMd5sumResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageMd5sumResponse.' + u;
                        }
                    }
                    if (e.storageRenameRequest != null && e.hasOwnProperty('storageRenameRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageRenameRequest.' + u;
                        }
                    }
                    if (e.storageBackupCreateRequest != null && e.hasOwnProperty('storageBackupCreateRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageBackupCreateRequest.' + u;
                        }
                    }
                    if (e.storageBackupRestoreRequest != null && e.hasOwnProperty('storageBackupRestoreRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'storageBackupRestoreRequest.' + u;
                        }
                    }
                    ...
                    if (e.appLockStatusRequest != null && e.hasOwnProperty('appLockStatusRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appLockStatusRequest.' + u;
                        }
                    }
                    if (e.appLockStatusResponse != null && e.hasOwnProperty('appLockStatusResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appLockStatusResponse.' + u;
                        }
                    }
                    ...
                    if (e.appLoadFileRequest != null && e.hasOwnProperty('appLoadFileRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appLoadFileRequest.' + u;
                        }
                    }
                    if (e.appButtonPressRequest != null && e.hasOwnProperty('appButtonPressRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appButtonPressRequest.' + u;
                        }
                    }
                    if (e.appButtonReleaseRequest != null && e.hasOwnProperty('appButtonReleaseRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appButtonReleaseRequest.' + u;
                        }
                    }
                    if (e.appGetErrorRequest != null && e.hasOwnProperty('appGetErrorRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appGetErrorRequest.' + u;
                        }
                    }
                    if (e.appGetErrorResponse != null && e.hasOwnProperty('appGetErrorResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appGetErrorResponse.' + u;
                        }
                    }
                    if (e.appDataExchangeRequest != null && e.hasOwnProperty('appDataExchangeRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appDataExchangeRequest.' + u;
                        }
                    }
                    if (e.guiStartScreenStreamRequest != null && e.hasOwnProperty('guiStartScreenStreamRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'guiStartScreenStreamRequest.' + u;
                        }
                    }
                    if (e.guiStopScreenStreamRequest != null && e.hasOwnProperty('guiStopScreenStreamRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'guiStopScreenStreamRequest.' + u;
                        }
                    }
                    ...
                    if (e.guiSendInputEventRequest != null && e.hasOwnProperty('guiSendInputEventRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'guiSendInputEventRequest.' + u;
                        }
                    }
                    if (e.guiStartVirtualDisplayRequest != null && e.hasOwnProperty('guiStartVirtualDisplayRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'guiStartVirtualDisplayRequest.' + u;
                        }
                    }
                    if (e.guiStopVirtualDisplayRequest != null && e.hasOwnProperty('guiStopVirtualDisplayRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'guiStopVirtualDisplayRequest.' + u;
                        }
                    }
                    ...
                    if (e.gpioSetInputPull != null && e.hasOwnProperty('gpioSetInputPull')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'gpioSetInputPull.' + u;
                        }
                    }
                    ...
                    if (e.gpioGetPinModeResponse != null && e.hasOwnProperty('gpioGetPinModeResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'gpioGetPinModeResponse.' + u;
                        }
                    }
                    ...
                    if (e.gpioReadPinResponse != null && e.hasOwnProperty('gpioReadPinResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'gpioReadPinResponse.' + u;
                        }
                    }
                    ...
                    if (e.appStateResponse != null && e.hasOwnProperty('appStateResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'appStateResponse.' + u;
                        }
                    }
                    if (e.propertyGetRequest != null && e.hasOwnProperty('propertyGetRequest')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'propertyGetRequest.' + u;
                        }
                    }
                    if (e.propertyGetResponse != null && e.hasOwnProperty('propertyGetResponse')) {
                        ...
                        i.content = 1;
                        {
                            ...
                            if (u) return 'propertyGetResponse.' + u;
                        }
                    }
                    return null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (e) {
                    if (e instanceof $root.PB.Main) return e;
                    ...
                    if ((e.hasNext != null && (i.hasNext = !!e.hasNext), e.empty != null)) {
                        if (typeof e.empty != 'object') throw TypeError('.PB.Main.empty: object expected');
                        i.empty = $root.PB.Empty.fromObject(e.empty);
                    }
                    if (e.stopSession != null) {
                        if (typeof e.stopSession != 'object') throw TypeError('.PB.Main.stopSession: object expected');
                    ...
                    if (e.systemDeviceInfoRequest != null) {
                        ...
                        i.systemDeviceInfoRequest = $root.PB_System.DeviceInfoRequest.fromObject(
                            e.systemDeviceInfoRequest
                        );
                    }
                    if (e.systemDeviceInfoResponse != null) {
                        ...
                        i.systemDeviceInfoResponse = $root.PB_System.DeviceInfoResponse.fromObject(
                            e.systemDeviceInfoResponse
                        );
                    }
                    if (e.systemFactoryResetRequest != null) {
                        ...
                        i.systemFactoryResetRequest = $root.PB_System.FactoryResetRequest.fromObject(
                            e.systemFactoryResetRequest
                        );
                    }
                    if (e.systemGetDatetimeRequest != null) {
                        ...
                        i.systemGetDatetimeRequest = $root.PB_System.GetDateTimeRequest.fromObject(
                            e.systemGetDatetimeRequest
                        );
                    }
                    if (e.systemGetDatetimeResponse != null) {
                        ...
                        i.systemGetDatetimeResponse = $root.PB_System.GetDateTimeResponse.fromObject(
                            e.systemGetDatetimeResponse
                        );
                    }
                    if (e.systemSetDatetimeRequest != null) {
                        ...
                        i.systemSetDatetimeRequest = $root.PB_System.SetDateTimeRequest.fromObject(
                            e.systemSetDatetimeRequest
                        );
                    }
                    if (e.systemPlayAudiovisualAlertRequest != null) {
                        ...
                        i.systemPlayAudiovisualAlertRequest = $root.PB_System.PlayAudiovisualAlertRequest.fromObject(
                            e.systemPlayAudiovisualAlertRequest
                        );
                    }
                    if (e.systemProtobufVersionRequest != null) {
                        ...
                        i.systemProtobufVersionRequest = $root.PB_System.ProtobufVersionRequest.fromObject(
                            e.systemProtobufVersionRequest
                        );
                    }
                    if (e.systemProtobufVersionResponse != null) {
                        ...
                        i.systemProtobufVersionResponse = $root.PB_System.ProtobufVersionResponse.fromObject(
                            e.systemProtobufVersionResponse
                        );
                    }
                    ...
                    if (e.systemPowerInfoRequest != null) {
                        ...
                        i.systemPowerInfoRequest = $root.PB_System.PowerInfoRequest.fromObject(
                            e.systemPowerInfoRequest
                        );
                    }
                    if (e.systemPowerInfoResponse != null) {
                        ...
                        i.systemPowerInfoResponse = $root.PB_System.PowerInfoResponse.fromObject(
                            e.systemPowerInfoResponse
                        );
                    }
                    ...
                    if (e.storageTimestampRequest != null) {
                        ...
                        i.storageTimestampRequest = $root.PB_Storage.TimestampRequest.fromObject(
                            e.storageTimestampRequest
                        );
                    }
                    if (e.storageTimestampResponse != null) {
                        ...
                        i.storageTimestampResponse = $root.PB_Storage.TimestampResponse.fromObject(
                            e.storageTimestampResponse
                        );
                    }
                    ...
                    if (e.storageBackupCreateRequest != null) {
                        ...
                        i.storageBackupCreateRequest = $root.PB_Storage.BackupCreateRequest.fromObject(
                            e.storageBackupCreateRequest
                        );
                    }
                    if (e.storageBackupRestoreRequest != null) {
                        ...
                        i.storageBackupRestoreRequest = $root.PB_Storage.BackupRestoreRequest.fromObject(
                            e.storageBackupRestoreRequest
                        );
                    }
                    ...
                    if (e.appButtonPressRequest != null) {
                        ...
                        i.appButtonPressRequest = $root.PB_App.AppButtonPressRequest.fromObject(
                            e.appButtonPressRequest
                        );
                    }
                    if (e.appButtonReleaseRequest != null) {
                        ...
                        i.appButtonReleaseRequest = $root.PB_App.AppButtonReleaseRequest.fromObject(
                            e.appButtonReleaseRequest
                        );
                    }
                    ...
                    if (e.appDataExchangeRequest != null) {
                        ...
                        i.appDataExchangeRequest = $root.PB_App.DataExchangeRequest.fromObject(
                            e.appDataExchangeRequest
                        );
                    }
                    if (e.guiStartScreenStreamRequest != null) {
                        ...
                        i.guiStartScreenStreamRequest = $root.PB_Gui.StartScreenStreamRequest.fromObject(
                            e.guiStartScreenStreamRequest
                        );
                    }
                    if (e.guiStopScreenStreamRequest != null) {
                        ...
                        i.guiStopScreenStreamRequest = $root.PB_Gui.StopScreenStreamRequest.fromObject(
                            e.guiStopScreenStreamRequest
                        );
                    }
                    ...
                    if (e.guiSendInputEventRequest != null) {
                        ...
                        i.guiSendInputEventRequest = $root.PB_Gui.SendInputEventRequest.fromObject(
                            e.guiSendInputEventRequest
                        );
                    }
                    if (e.guiStartVirtualDisplayRequest != null) {
                        ...
                        i.guiStartVirtualDisplayRequest = $root.PB_Gui.StartVirtualDisplayRequest.fromObject(
                            e.guiStartVirtualDisplayRequest
                        );
                    }
                    if (e.guiStopVirtualDisplayRequest != null) {
                        ...
                        i.guiStopVirtualDisplayRequest = $root.PB_Gui.StopVirtualDisplayRequest.fromObject(
                            e.guiStopVirtualDisplayRequest
                        );
                    }
                    ...
                    if (e.gpioGetPinModeResponse != null) {
                        ...
                        i.gpioGetPinModeResponse = $root.PB_Gpio.GetPinModeResponse.fromObject(
                            e.gpioGetPinModeResponse
                        );
                    }
                    if (e.gpioReadPin != null) {
                        if (typeof e.gpioReadPin != 'object') throw TypeError('.PB.Main.gpioReadPin: object expected');
                ...
                (n.toObject = /* @__PURE__ */ r(function (e, i) {
                    i || (i = {});
                    const u = {};
                    return (
                        i.defaults &&
                            ((u.commandId = 0), (u.commandStatus = i.enums === String ? 'OK' : 0), (u.hasNext = !1)),
                        e.commandId != null && e.hasOwnProperty('commandId') && (u.commandId = e.commandId),
                        e.commandStatus != null &&
                            e.hasOwnProperty('commandStatus') &&
                            (u.commandStatus =
                                i.enums === String ? $root.PB.CommandStatus[e.commandStatus] : e.commandStatus),
                        e.hasNext != null && e.hasOwnProperty('hasNext') && (u.hasNext = e.hasNext),
                        e.empty != null &&
                            e.hasOwnProperty('empty') &&
                            ((u.empty = $root.PB.Empty.toObject(e.empty, i)), i.oneofs && (u.content = 'empty')),
                        e.systemPingRequest != null &&
                            e.hasOwnProperty('systemPingRequest') &&
                            ((u.systemPingRequest = $root.PB_System.PingRequest.toObject(e.systemPingRequest, i)),
                            i.oneofs && (u.content = 'systemPingRequest')),
                        e.systemPingResponse != null &&
                            e.hasOwnProperty('systemPingResponse') &&
                            ((u.systemPingResponse = $root.PB_System.PingResponse.toObject(e.systemPingResponse, i)),
                            i.oneofs && (u.content = 'systemPingResponse')),
                        e.storageListRequest != null &&
                            e.hasOwnProperty('storageListRequest') &&
                            ((u.storageListRequest = $root.PB_Storage.ListRequest.toObject(e.storageListRequest, i)),
                            i.oneofs && (u.content = 'storageListRequest')),
                        e.storageListResponse != null &&
                            e.hasOwnProperty('storageListResponse') &&
                            ((u.storageListResponse = $root.PB_Storage.ListResponse.toObject(e.storageListResponse, i)),
                            i.oneofs && (u.content = 'storageListResponse')),
                        e.storageReadRequest != null &&
                            e.hasOwnProperty('storageReadRequest') &&
                            ((u.storageReadRequest = $root.PB_Storage.ReadRequest.toObject(e.storageReadRequest, i)),
                            i.oneofs && (u.content = 'storageReadRequest')),
                        e.storageReadResponse != null &&
                            e.hasOwnProperty('storageReadResponse') &&
                            ((u.storageReadResponse = $root.PB_Storage.ReadResponse.toObject(e.storageReadResponse, i)),
                            i.oneofs && (u.content = 'storageReadResponse')),
                        e.storageWriteRequest != null &&
                            e.hasOwnProperty('storageWriteRequest') &&
                            ((u.storageWriteRequest = $root.PB_Storage.WriteRequest.toObject(e.storageWriteRequest, i)),
                            i.oneofs && (u.content = 'storageWriteRequest')),
                        e.storageDeleteRequest != null &&
                            e.hasOwnProperty('storageDeleteRequest') &&
                            ((u.storageDeleteRequest = $root.PB_Storage.DeleteRequest.toObject(
                                e.storageDeleteRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'storageDeleteRequest')),
                        e.storageMkdirRequest != null &&
                            e.hasOwnProperty('storageMkdirRequest') &&
                            ((u.storageMkdirRequest = $root.PB_Storage.MkdirRequest.toObject(e.storageMkdirRequest, i)),
                            i.oneofs && (u.content = 'storageMkdirRequest')),
                        e.storageMd5sumRequest != null &&
                            e.hasOwnProperty('storageMd5sumRequest') &&
                            ((u.storageMd5sumRequest = $root.PB_Storage.Md5sumRequest.toObject(
                                e.storageMd5sumRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'storageMd5sumRequest')),
                        e.storageMd5sumResponse != null &&
                            e.hasOwnProperty('storageMd5sumResponse') &&
                            ((u.storageMd5sumResponse = $root.PB_Storage.Md5sumResponse.toObject(
                                e.storageMd5sumResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'storageMd5sumResponse')),
                        e.appStartRequest != null &&
                            e.hasOwnProperty('appStartRequest') &&
                            ((u.appStartRequest = $root.PB_App.StartRequest.toObject(e.appStartRequest, i)),
                            i.oneofs && (u.content = 'appStartRequest')),
                        e.appLockStatusRequest != null &&
                            e.hasOwnProperty('appLockStatusRequest') &&
                            ((u.appLockStatusRequest = $root.PB_App.LockStatusRequest.toObject(
                                e.appLockStatusRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'appLockStatusRequest')),
                        e.appLockStatusResponse != null &&
                            e.hasOwnProperty('appLockStatusResponse') &&
                            ((u.appLockStatusResponse = $root.PB_App.LockStatusResponse.toObject(
                                e.appLockStatusResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'appLockStatusResponse')),
                        e.stopSession != null &&
                            e.hasOwnProperty('stopSession') &&
                            ((u.stopSession = $root.PB.StopSession.toObject(e.stopSession, i)),
                            i.oneofs && (u.content = 'stopSession')),
                        e.guiStartScreenStreamRequest != null &&
                            e.hasOwnProperty('guiStartScreenStreamRequest') &&
                            ((u.guiStartScreenStreamRequest = $root.PB_Gui.StartScreenStreamRequest.toObject(
                                e.guiStartScreenStreamRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'guiStartScreenStreamRequest')),
                        e.guiStopScreenStreamRequest != null &&
                            e.hasOwnProperty('guiStopScreenStreamRequest') &&
                            ((u.guiStopScreenStreamRequest = $root.PB_Gui.StopScreenStreamRequest.toObject(
                                e.guiStopScreenStreamRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'guiStopScreenStreamRequest')),
                        e.guiScreenFrame != null &&
                            e.hasOwnProperty('guiScreenFrame') &&
                            ((u.guiScreenFrame = $root.PB_Gui.ScreenFrame.toObject(e.guiScreenFrame, i)),
                            i.oneofs && (u.content = 'guiScreenFrame')),
                        e.guiSendInputEventRequest != null &&
                            e.hasOwnProperty('guiSendInputEventRequest') &&
                            ((u.guiSendInputEventRequest = $root.PB_Gui.SendInputEventRequest.toObject(
                                e.guiSendInputEventRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'guiSendInputEventRequest')),
                        e.storageStatRequest != null &&
                            e.hasOwnProperty('storageStatRequest') &&
                            ((u.storageStatRequest = $root.PB_Storage.StatRequest.toObject(e.storageStatRequest, i)),
                            i.oneofs && (u.content = 'storageStatRequest')),
                        e.storageStatResponse != null &&
                            e.hasOwnProperty('storageStatResponse') &&
                            ((u.storageStatResponse = $root.PB_Storage.StatResponse.toObject(e.storageStatResponse, i)),
                            i.oneofs && (u.content = 'storageStatResponse')),
                        e.guiStartVirtualDisplayRequest != null &&
                            e.hasOwnProperty('guiStartVirtualDisplayRequest') &&
                            ((u.guiStartVirtualDisplayRequest = $root.PB_Gui.StartVirtualDisplayRequest.toObject(
                                e.guiStartVirtualDisplayRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'guiStartVirtualDisplayRequest')),
                        e.guiStopVirtualDisplayRequest != null &&
                            e.hasOwnProperty('guiStopVirtualDisplayRequest') &&
                            ((u.guiStopVirtualDisplayRequest = $root.PB_Gui.StopVirtualDisplayRequest.toObject(
                                e.guiStopVirtualDisplayRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'guiStopVirtualDisplayRequest')),
                        e.storageInfoRequest != null &&
                            e.hasOwnProperty('storageInfoRequest') &&
                            ((u.storageInfoRequest = $root.PB_Storage.InfoRequest.toObject(e.storageInfoRequest, i)),
                            i.oneofs && (u.content = 'storageInfoRequest')),
                        e.storageInfoResponse != null &&
                            e.hasOwnProperty('storageInfoResponse') &&
                            ((u.storageInfoResponse = $root.PB_Storage.InfoResponse.toObject(e.storageInfoResponse, i)),
                            i.oneofs && (u.content = 'storageInfoResponse')),
                        e.storageRenameRequest != null &&
                            e.hasOwnProperty('storageRenameRequest') &&
                            ((u.storageRenameRequest = $root.PB_Storage.RenameRequest.toObject(
                                e.storageRenameRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'storageRenameRequest')),
                        e.systemRebootRequest != null &&
                            e.hasOwnProperty('systemRebootRequest') &&
                            ((u.systemRebootRequest = $root.PB_System.RebootRequest.toObject(e.systemRebootRequest, i)),
                            i.oneofs && (u.content = 'systemRebootRequest')),
                        e.systemDeviceInfoRequest != null &&
                            e.hasOwnProperty('systemDeviceInfoRequest') &&
                            ((u.systemDeviceInfoRequest = $root.PB_System.DeviceInfoRequest.toObject(
                                e.systemDeviceInfoRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'systemDeviceInfoRequest')),
                        e.systemDeviceInfoResponse != null &&
                            e.hasOwnProperty('systemDeviceInfoResponse') &&
                            ((u.systemDeviceInfoResponse = $root.PB_System.DeviceInfoResponse.toObject(
                                e.systemDeviceInfoResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'systemDeviceInfoResponse')),
                        e.systemFactoryResetRequest != null &&
                            e.hasOwnProperty('systemFactoryResetRequest') &&
                            ((u.systemFactoryResetRequest = $root.PB_System.FactoryResetRequest.toObject(
                                e.systemFactoryResetRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'systemFactoryResetRequest')),
                        e.systemGetDatetimeRequest != null &&
                            e.hasOwnProperty('systemGetDatetimeRequest') &&
                            ((u.systemGetDatetimeRequest = $root.PB_System.GetDateTimeRequest.toObject(
                                e.systemGetDatetimeRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'systemGetDatetimeRequest')),
                        e.systemGetDatetimeResponse != null &&
                            e.hasOwnProperty('systemGetDatetimeResponse') &&
                            ((u.systemGetDatetimeResponse = $root.PB_System.GetDateTimeResponse.toObject(
                                e.systemGetDatetimeResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'systemGetDatetimeResponse')),
                        e.systemSetDatetimeRequest != null &&
                            e.hasOwnProperty('systemSetDatetimeRequest') &&
                            ((u.systemSetDatetimeRequest = $root.PB_System.SetDateTimeRequest.toObject(
                                e.systemSetDatetimeRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'systemSetDatetimeRequest')),
                        e.systemPlayAudiovisualAlertRequest != null &&
                            e.hasOwnProperty('systemPlayAudiovisualAlertRequest') &&
                            ((u.systemPlayAudiovisualAlertRequest =
                                $root.PB_System.PlayAudiovisualAlertRequest.toObject(
                                    e.systemPlayAudiovisualAlertRequest,
                                    i
                                )),
                            i.oneofs && (u.content = 'systemPlayAudiovisualAlertRequest')),
                        e.systemProtobufVersionRequest != null &&
                            e.hasOwnProperty('systemProtobufVersionRequest') &&
                            ((u.systemProtobufVersionRequest = $root.PB_System.ProtobufVersionRequest.toObject(
                                e.systemProtobufVersionRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'systemProtobufVersionRequest')),
                        e.systemProtobufVersionResponse != null &&
                            e.hasOwnProperty('systemProtobufVersionResponse') &&
                            ((u.systemProtobufVersionResponse = $root.PB_System.ProtobufVersionResponse.toObject(
                                e.systemProtobufVersionResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'systemProtobufVersionResponse')),
                        e.systemUpdateRequest != null &&
                            e.hasOwnProperty('systemUpdateRequest') &&
                            ((u.systemUpdateRequest = $root.PB_System.UpdateRequest.toObject(e.systemUpdateRequest, i)),
                            i.oneofs && (u.content = 'systemUpdateRequest')),
                        e.storageBackupCreateRequest != null &&
                            e.hasOwnProperty('storageBackupCreateRequest') &&
                            ((u.storageBackupCreateRequest = $root.PB_Storage.BackupCreateRequest.toObject(
                                e.storageBackupCreateRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'storageBackupCreateRequest')),
                        e.storageBackupRestoreRequest != null &&
                            e.hasOwnProperty('storageBackupRestoreRequest') &&
                            ((u.storageBackupRestoreRequest = $root.PB_Storage.BackupRestoreRequest.toObject(
                                e.storageBackupRestoreRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'storageBackupRestoreRequest')),
                        e.systemPowerInfoRequest != null &&
                            e.hasOwnProperty('systemPowerInfoRequest') &&
                            ((u.systemPowerInfoRequest = $root.PB_System.PowerInfoRequest.toObject(
                                e.systemPowerInfoRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'systemPowerInfoRequest')),
                        e.systemPowerInfoResponse != null &&
                            e.hasOwnProperty('systemPowerInfoResponse') &&
                            ((u.systemPowerInfoResponse = $root.PB_System.PowerInfoResponse.toObject(
                                e.systemPowerInfoResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'systemPowerInfoResponse')),
                        e.systemUpdateResponse != null &&
                            e.hasOwnProperty('systemUpdateResponse') &&
                            ((u.systemUpdateResponse = $root.PB_System.UpdateResponse.toObject(
                                e.systemUpdateResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'systemUpdateResponse')),
                        e.appExitRequest != null &&
                            e.hasOwnProperty('appExitRequest') &&
                            ((u.appExitRequest = $root.PB_App.AppExitRequest.toObject(e.appExitRequest, i)),
                            i.oneofs && (u.content = 'appExitRequest')),
                        e.appLoadFileRequest != null &&
                            e.hasOwnProperty('appLoadFileRequest') &&
                            ((u.appLoadFileRequest = $root.PB_App.AppLoadFileRequest.toObject(e.appLoadFileRequest, i)),
                            i.oneofs && (u.content = 'appLoadFileRequest')),
                        e.appButtonPressRequest != null &&
                            e.hasOwnProperty('appButtonPressRequest') &&
                            ((u.appButtonPressRequest = $root.PB_App.AppButtonPressRequest.toObject(
                                e.appButtonPressRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'appButtonPressRequest')),
                        e.appButtonReleaseRequest != null &&
                            e.hasOwnProperty('appButtonReleaseRequest') &&
                            ((u.appButtonReleaseRequest = $root.PB_App.AppButtonReleaseRequest.toObject(
                                e.appButtonReleaseRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'appButtonReleaseRequest')),
                        e.gpioSetPinMode != null &&
                            e.hasOwnProperty('gpioSetPinMode') &&
                            ((u.gpioSetPinMode = $root.PB_Gpio.SetPinMode.toObject(e.gpioSetPinMode, i)),
                            i.oneofs && (u.content = 'gpioSetPinMode')),
                        e.gpioSetInputPull != null &&
                            e.hasOwnProperty('gpioSetInputPull') &&
                            ((u.gpioSetInputPull = $root.PB_Gpio.SetInputPull.toObject(e.gpioSetInputPull, i)),
                            i.oneofs && (u.content = 'gpioSetInputPull')),
                        e.gpioGetPinMode != null &&
                            e.hasOwnProperty('gpioGetPinMode') &&
                            ((u.gpioGetPinMode = $root.PB_Gpio.GetPinMode.toObject(e.gpioGetPinMode, i)),
                            i.oneofs && (u.content = 'gpioGetPinMode')),
                        e.gpioGetPinModeResponse != null &&
                            e.hasOwnProperty('gpioGetPinModeResponse') &&
                            ((u.gpioGetPinModeResponse = $root.PB_Gpio.GetPinModeResponse.toObject(
                                e.gpioGetPinModeResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'gpioGetPinModeResponse')),
                        e.gpioReadPin != null &&
                            e.hasOwnProperty('gpioReadPin') &&
                            ((u.gpioReadPin = $root.PB_Gpio.ReadPin.toObject(e.gpioReadPin, i)),
                            i.oneofs && (u.content = 'gpioReadPin')),
                        e.gpioReadPinResponse != null &&
                            e.hasOwnProperty('gpioReadPinResponse') &&
                            ((u.gpioReadPinResponse = $root.PB_Gpio.ReadPinResponse.toObject(e.gpioReadPinResponse, i)),
                            i.oneofs && (u.content = 'gpioReadPinResponse')),
                        e.gpioWritePin != null &&
                            e.hasOwnProperty('gpioWritePin') &&
                            ((u.gpioWritePin = $root.PB_Gpio.WritePin.toObject(e.gpioWritePin, i)),
                            i.oneofs && (u.content = 'gpioWritePin')),
                        e.appStateResponse != null &&
                            e.hasOwnProperty('appStateResponse') &&
                            ((u.appStateResponse = $root.PB_App.AppStateResponse.toObject(e.appStateResponse, i)),
                            i.oneofs && (u.content = 'appStateResponse')),
                        e.storageTimestampRequest != null &&
                            e.hasOwnProperty('storageTimestampRequest') &&
                            ((u.storageTimestampRequest = $root.PB_Storage.TimestampRequest.toObject(
                                e.storageTimestampRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'storageTimestampRequest')),
                        e.storageTimestampResponse != null &&
                            e.hasOwnProperty('storageTimestampResponse') &&
                            ((u.storageTimestampResponse = $root.PB_Storage.TimestampResponse.toObject(
                                e.storageTimestampResponse,
                                i
                            )),
                            i.oneofs && (u.content = 'storageTimestampResponse')),
                        e.propertyGetRequest != null &&
                            e.hasOwnProperty('propertyGetRequest') &&
                            ((u.propertyGetRequest = $root.PB_Property.GetRequest.toObject(e.propertyGetRequest, i)),
                            i.oneofs && (u.content = 'propertyGetRequest')),
                        e.propertyGetResponse != null &&
                            e.hasOwnProperty('propertyGetResponse') &&
                            ((u.propertyGetResponse = $root.PB_Property.GetResponse.toObject(e.propertyGetResponse, i)),
                            i.oneofs && (u.content = 'propertyGetResponse')),
                        e.appGetErrorRequest != null &&
                            e.hasOwnProperty('appGetErrorRequest') &&
                            ((u.appGetErrorRequest = $root.PB_App.GetErrorRequest.toObject(e.appGetErrorRequest, i)),
                            i.oneofs && (u.content = 'appGetErrorRequest')),
                        e.appGetErrorResponse != null &&
                            e.hasOwnProperty('appGetErrorResponse') &&
                            ((u.appGetErrorResponse = $root.PB_App.GetErrorResponse.toObject(e.appGetErrorResponse, i)),
                            i.oneofs && (u.content = 'appGetErrorResponse')),
                        e.appDataExchangeRequest != null &&
                            e.hasOwnProperty('appDataExchangeRequest') &&
                            ((u.appDataExchangeRequest = $root.PB_App.DataExchangeRequest.toObject(
                                e.appDataExchangeRequest,
                                i
                            )),
                            i.oneofs && (u.content = 'appDataExchangeRequest')),
                        u
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.Region = (function () {
            function n(o) {
                if (((this.bands = []), o))
                    for (let t = Object.keys(o), e = 0; e < t.length; ++e) o[t[e]] != null && (this[t[e]] = o[t[e]]);
            }
            return (
                r(n, 'Region'),
                (n.prototype.countryCode = $util.newBuffer([])),
                (n.prototype.bands = $util.emptyArray),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    if (
                        ...
                        t.countryCode != null &&
                            ...
                            e.uint32(10).bytes(t.countryCode),
                        t.bands != null && t.bands.length)
                    )
                    ...
                    for (; t.pos < i; ) {
                        ...
                        switch (c >>> 3) {
                            case 1:
                                ...
                                break;
                            case 2:
                                (u.bands && u.bands.length) || (u.bands = []),
                                    u.bands.push($root.PB.Region.Band.decode(t, t.uint32()));
                                break;
                            default:
                                t.skipType(c & 7);
                                break;
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    ...
                    if (
                        t.countryCode != null &&
                        t.hasOwnProperty('countryCode') &&
                        !((t.countryCode && typeof t.countryCode.length == 'number') || $util.isString(t.countryCode))
                    )
                        return 'countryCode: buffer expected';
                    if (t.bands != null && t.hasOwnProperty('bands')) {
                        if (!Array.isArray(t.bands)) return 'bands: array expected';
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB.Region) return t;
                    ...
                    if (
                        (t.countryCode != null &&
                            (typeof t.countryCode == 'string'
                                ? $util.base64.decode(
                                      t.countryCode,
                                      (e.countryCode = $util.newBuffer($util.base64.length(t.countryCode))),
                                      0
                                  )
                                : t.countryCode.length && (e.countryCode = t.countryCode)),
                        t.bands)
                    ) {
                        if (!Array.isArray(t.bands)) throw TypeError('.PB.Region.bands: array expected');
                        e.bands = [];
                        for (let i = 0; i < t.bands.length; ++i) {
                            if (typeof t.bands[i] != 'object') throw TypeError('.PB.Region.bands: object expected');
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    if (
                        ((e.arrays || e.defaults) && (i.bands = []),
                        e.defaults &&
                            (e.bytes === String
                                ? (i.countryCode = '')
                                : ((i.countryCode = []),
                                  e.bytes !== Array && (i.countryCode = $util.newBuffer(i.countryCode)))),
                        t.countryCode != null &&
                            t.hasOwnProperty('countryCode') &&
                            (i.countryCode =
                                e.bytes === String
                                    ? $util.base64.encode(t.countryCode, 0, t.countryCode.length)
                                    : e.bytes === Array
                                      ? Array.prototype.slice.call(t.countryCode)
                                      : t.countryCode),
                ...
                (n.Band = (function () {
                    ...
                    return (
                        ...
                        (o.prototype.start = 0),
                        (o.prototype.end = 0),
                        (o.prototype.powerLimit = 0),
                        (o.prototype.dutyCycle = 0),
                        (o.create = /* @__PURE__ */ r(function (e) {
                            return new o(e);
                        }, 'create')),
                        (o.encode = /* @__PURE__ */ r(function (e, i) {
                            return (
                                i || (i = $Writer.create()),
                                e.start != null &&
                                    Object.hasOwnProperty.call(e, 'start') &&
                                    i.uint32(8).uint32(e.start),
                                e.end != null && Object.hasOwnProperty.call(e, 'end') && i.uint32(16).uint32(e.end),
                                e.powerLimit != null &&
                                    Object.hasOwnProperty.call(e, 'powerLimit') &&
                                    i.uint32(24).int32(e.powerLimit),
                                e.dutyCycle != null &&
                                    Object.hasOwnProperty.call(e, 'dutyCycle') &&
                                    i.uint32(32).uint32(e.dutyCycle),
                                i
                            );
                        }, 'encode')),
                        (o.encodeDelimited = /* @__PURE__ */ r(function (e, i) {
                            return this.encode(e, i).ldelim();
                        }, 'encodeDelimited')),
                        (o.decode = /* @__PURE__ */ r(function (e, i) {
                            e instanceof $Reader || (e = $Reader.create(e));
                            const u = i === void 0 ? e.len : e.pos + i,
                                c = new $root.PB.Region.Band();
                            for (; e.pos < u; ) {
                                const l = e.uint32();
                                switch (l >>> 3) {
                                    case 1:
                        ...
                        (o.decodeDelimited = /* @__PURE__ */ r(function (e) {
                            return e instanceof $Reader || (e = new $Reader(e)), this.decode(e, e.uint32());
                        }, 'decodeDelimited')),
                        (o.verify = /* @__PURE__ */ r(function (e) {
                            return typeof e != 'object' || e === null
                                ? 'object expected'
                                : e.start != null && e.hasOwnProperty('start') && !$util.isInteger(e.start)
                                  ? 'start: integer expected'
                                  : e.end != null && e.hasOwnProperty('end') && !$util.isInteger(e.end)
                                    ? 'end: integer expected'
                                    : e.powerLimit != null &&
                                        e.hasOwnProperty('powerLimit') &&
                                        !$util.isInteger(e.powerLimit)
                                      ? 'powerLimit: integer expected'
                                      : e.dutyCycle != null &&
                                          e.hasOwnProperty('dutyCycle') &&
                                          !$util.isInteger(e.dutyCycle)
                                        ? 'dutyCycle: integer expected'
                                        : null;
                        }, 'verify')),
                        (o.fromObject = /* @__PURE__ */ r(function (e) {
                            if (e instanceof $root.PB.Region.Band) return e;
                            const i = new $root.PB.Region.Band();
                            return (
                                e.start != null && (i.start = e.start >>> 0),
                                e.end != null && (i.end = e.end >>> 0),
                                e.powerLimit != null && (i.powerLimit = e.powerLimit | 0),
                                e.dutyCycle != null && (i.dutyCycle = e.dutyCycle >>> 0),
                                i
                            );
                        }, 'fromObject')),
                        (o.toObject = /* @__PURE__ */ r(function (e, i) {
                            i || (i = {});
                            const u = {};
                            return (
                                i.defaults && ((u.start = 0), (u.end = 0), (u.powerLimit = 0), (u.dutyCycle = 0)),
                                e.start != null && e.hasOwnProperty('start') && (u.start = e.start),
                                e.end != null && e.hasOwnProperty('end') && (u.end = e.end),
                                e.powerLimit != null && e.hasOwnProperty('powerLimit') && (u.powerLimit = e.powerLimit),
                                e.dutyCycle != null && e.hasOwnProperty('dutyCycle') && (u.dutyCycle = e.dutyCycle),
                                u
                            );
                        }, 'toObject')),
                        (o.prototype.toJSON = /* @__PURE__ */ r(function () {
                            return this.constructor.toObject(this, minimal.util.toJSONOptions);
                        }, 'toJSON')),
                        o
                    );
...
$root.PB_Storage = (() => {
    ...
    return (
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        ...
                        t.size != null && Object.hasOwnProperty.call(t, 'size') && e.uint32(24).uint32(t.size),
                        t.data != null && Object.hasOwnProperty.call(t, 'data') && e.uint32(34).bytes(t.data),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    ...
                    return t.name != null && t.hasOwnProperty('name') && !$util.isString(t.name)
                        ? 'name: string expected'
                        : t.size != null && t.hasOwnProperty('size') && !$util.isInteger(t.size)
                          ? 'size: integer expected'
                          : t.data != null &&
                              t.hasOwnProperty('data') &&
                              !((t.data && typeof t.data.length == 'number') || $util.isString(t.data))
                            ? 'data: buffer expected'
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.File) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        ...
                        t.type != null &&
                            ...
                            (i.type = e.enums === String ? $root.PB_Storage.File.FileType[t.type] : t.type),
                        t.name != null && t.hasOwnProperty('name') && (i.name = t.name),
                        t.size != null && t.hasOwnProperty('size') && (i.size = t.size),
                        t.data != null &&
                            t.hasOwnProperty('data') &&
                            (i.data =
                                e.bytes === String
        ...
        (s.InfoRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.InfoRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.InfoRequest) return t;
        ...
        (s.InfoResponse = (function () {
            ...
            return (
                r(n, 'InfoResponse'),
                (n.prototype.totalSpace = $util.Long ? $util.Long.fromBits(0, 0, !0) : 0),
                (n.prototype.freeSpace = $util.Long ? $util.Long.fromBits(0, 0, !0) : 0),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.totalSpace != null &&
                            Object.hasOwnProperty.call(t, 'totalSpace') &&
                            e.uint32(8).uint64(t.totalSpace),
                        t.freeSpace != null &&
                            Object.hasOwnProperty.call(t, 'freeSpace') &&
                            e.uint32(16).uint64(t.freeSpace),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.InfoResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.totalSpace != null &&
                            t.hasOwnProperty('totalSpace') &&
                            !$util.isInteger(t.totalSpace) &&
                            !(t.totalSpace && $util.isInteger(t.totalSpace.low) && $util.isInteger(t.totalSpace.high))
                          ? 'totalSpace: integer|Long expected'
                          : t.freeSpace != null &&
                              t.hasOwnProperty('freeSpace') &&
                              !$util.isInteger(t.freeSpace) &&
                              !(t.freeSpace && $util.isInteger(t.freeSpace.low) && $util.isInteger(t.freeSpace.high))
                            ? 'freeSpace: integer|Long expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.InfoResponse) return t;
                    const e = new $root.PB_Storage.InfoResponse();
                    return (
                        t.totalSpace != null &&
                            ($util.Long
                                ? ((e.totalSpace = $util.Long.fromValue(t.totalSpace)).unsigned = !0)
                                : typeof t.totalSpace == 'string'
                                  ? (e.totalSpace = parseInt(t.totalSpace, 10))
                                  : typeof t.totalSpace == 'number'
                                    ? (e.totalSpace = t.totalSpace)
                                    : typeof t.totalSpace == 'object' &&
                                      (e.totalSpace = new $util.LongBits(
                                          t.totalSpace.low >>> 0,
                                          t.totalSpace.high >>> 0
                                      ).toNumber(!0))),
                        t.freeSpace != null &&
                            ($util.Long
                                ? ((e.freeSpace = $util.Long.fromValue(t.freeSpace)).unsigned = !0)
                                : typeof t.freeSpace == 'string'
                                  ? (e.freeSpace = parseInt(t.freeSpace, 10))
                                  : typeof t.freeSpace == 'number'
                                    ? (e.freeSpace = t.freeSpace)
                                    : typeof t.freeSpace == 'object' &&
                                      (e.freeSpace = new $util.LongBits(
                                          t.freeSpace.low >>> 0,
                                          t.freeSpace.high >>> 0
                                      ).toNumber(!0))),
                        e
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    if (e.defaults) {
                        ...
                        } else i.totalSpace = e.longs === String ? '0' : 0;
                        if ($util.Long) {
                            const u = new $util.Long(0, 0, !0);
                            i.freeSpace = e.longs === String ? u.toString() : e.longs === Number ? u.toNumber() : u;
                        } else i.freeSpace = e.longs === String ? '0' : 0;
                    }
                    return (
                        t.totalSpace != null &&
                            t.hasOwnProperty('totalSpace') &&
                            (typeof t.totalSpace == 'number'
                                ? (i.totalSpace = e.longs === String ? String(t.totalSpace) : t.totalSpace)
                                : (i.totalSpace =
                                      e.longs === String
                                          ? $util.Long.prototype.toString.call(t.totalSpace)
                                          : e.longs === Number
                                            ? new $util.LongBits(
                                                  t.totalSpace.low >>> 0,
                                                  t.totalSpace.high >>> 0
                        ...
                        t.freeSpace != null &&
                            t.hasOwnProperty('freeSpace') &&
                            (typeof t.freeSpace == 'number'
                                ? (i.freeSpace = e.longs === String ? String(t.freeSpace) : t.freeSpace)
                                : (i.freeSpace =
                                      e.longs === String
                                          ? $util.Long.prototype.toString.call(t.freeSpace)
                                          : e.longs === Number
                                            ? new $util.LongBits(
                                                  t.freeSpace.low >>> 0,
                                                  t.freeSpace.high >>> 0
        ...
        (s.TimestampRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.TimestampRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.TimestampRequest) return t;
        ...
        (s.TimestampResponse = (function () {
            ...
            return (
                r(n, 'TimestampResponse'),
                (n.prototype.timestamp = 0),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.TimestampResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.timestamp != null && t.hasOwnProperty('timestamp') && !$util.isInteger(t.timestamp)
                          ? 'timestamp: integer expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.TimestampResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.timestamp = 0),
                        t.timestamp != null && t.hasOwnProperty('timestamp') && (i.timestamp = t.timestamp),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.StatRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.StatRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.StatRequest) return t;
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.file != null &&
                            Object.hasOwnProperty.call(t, 'file') &&
                            $root.PB_Storage.File.encode(t.file, e.uint32(10).fork()).ldelim(),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.StatResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.StatResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.file = null),
                        t.file != null &&
                            t.hasOwnProperty('file') &&
                            (i.file = $root.PB_Storage.File.toObject(t.file, e)),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.ListRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.ListRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.ListRequest) return t;
        ...
        (s.ListResponse = (function () {
            ...
            return (
                r(n, 'ListResponse'),
                (n.prototype.file = $util.emptyArray),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.ListResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                                (u.file && u.file.length) || (u.file = []),
                                    u.file.push($root.PB_Storage.File.decode(t, t.uint32()));
                                break;
                            default:
                                t.skipType(c & 7);
                                break;
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    if (typeof t != 'object' || t === null) return 'object expected';
                    if (t.file != null && t.hasOwnProperty('file')) {
                        if (!Array.isArray(t.file)) return 'file: array expected';
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.ListResponse) return t;
                    const e = new $root.PB_Storage.ListResponse();
                    if (t.file) {
                        if (!Array.isArray(t.file)) throw TypeError('.PB_Storage.ListResponse.file: array expected');
                        e.file = [];
                        for (let i = 0; i < t.file.length; ++i) {
        ...
        (s.ReadRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.ReadRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.ReadRequest) return t;
        ...
        (s.ReadResponse = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.ReadResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.ReadResponse) return t;
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        ...
                        t.file != null &&
                            Object.hasOwnProperty.call(t, 'file') &&
                            $root.PB_Storage.File.encode(t.file, e.uint32(18).fork()).ldelim(),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.WriteRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.WriteRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && ((i.path = ''), (i.file = null)),
                        t.path != null && t.hasOwnProperty('path') && (i.path = t.path),
                        t.file != null &&
                            t.hasOwnProperty('file') &&
                            (i.file = $root.PB_Storage.File.toObject(t.file, e)),
                        i
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        ...
                        t.path != null && Object.hasOwnProperty.call(t, 'path') && e.uint32(10).string(t.path),
                        t.recursive != null &&
                            Object.hasOwnProperty.call(t, 'recursive') &&
                            e.uint32(16).bool(t.recursive),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.DeleteRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ...
                        : t.path != null && t.hasOwnProperty('path') && !$util.isString(t.path)
                          ? 'path: string expected'
                          : t.recursive != null && t.hasOwnProperty('recursive') && typeof t.recursive != 'boolean'
                            ? 'recursive: boolean expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.DeleteRequest) return t;
                    const e = new $root.PB_Storage.DeleteRequest();
                    return (
                        t.path != null && (e.path = String(t.path)),
                        t.recursive != null && (e.recursive = !!t.recursive),
                        e
                    );
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && ((i.path = ''), (i.recursive = !1)),
                        t.path != null && t.hasOwnProperty('path') && (i.path = t.path),
                        t.recursive != null && t.hasOwnProperty('recursive') && (i.recursive = t.recursive),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.MkdirRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.MkdirRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.MkdirRequest) return t;
        ...
        (s.Md5sumRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.Md5sumRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.Md5sumRequest) return t;
        ...
        (s.Md5sumResponse = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.md5sum != null && Object.hasOwnProperty.call(t, 'md5sum') && e.uint32(10).string(t.md5sum),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.Md5sumResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.md5sum != null && t.hasOwnProperty('md5sum') && !$util.isString(t.md5sum)
                          ? 'md5sum: string expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.Md5sumResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        e.defaults && (i.md5sum = ''),
                        t.md5sum != null && t.hasOwnProperty('md5sum') && (i.md5sum = t.md5sum),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.RenameRequest = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.oldPath != null && Object.hasOwnProperty.call(t, 'oldPath') && e.uint32(10).string(t.oldPath),
                        t.newPath != null && Object.hasOwnProperty.call(t, 'newPath') && e.uint32(18).string(t.newPath),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.RenameRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.oldPath != null && t.hasOwnProperty('oldPath') && !$util.isString(t.oldPath)
                          ? 'oldPath: string expected'
                          : t.newPath != null && t.hasOwnProperty('newPath') && !$util.isString(t.newPath)
                            ? 'newPath: string expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.RenameRequest) return t;
                    const e = new $root.PB_Storage.RenameRequest();
                    return (
                        t.oldPath != null && (e.oldPath = String(t.oldPath)),
                        t.newPath != null && (e.newPath = String(t.newPath)),
                        e
                    );
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && ((i.oldPath = ''), (i.newPath = '')),
                        t.oldPath != null && t.hasOwnProperty('oldPath') && (i.oldPath = t.oldPath),
                        t.newPath != null && t.hasOwnProperty('newPath') && (i.newPath = t.newPath),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.BackupCreateRequest = (function () {
            ...
            return (
                r(n, 'BackupCreateRequest'),
                (n.prototype.archivePath = ''),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.archivePath != null &&
                            Object.hasOwnProperty.call(t, 'archivePath') &&
                            e.uint32(10).string(t.archivePath),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.BackupCreateRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.archivePath != null && t.hasOwnProperty('archivePath') && !$util.isString(t.archivePath)
                          ? 'archivePath: string expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.BackupCreateRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.archivePath = ''),
                        t.archivePath != null && t.hasOwnProperty('archivePath') && (i.archivePath = t.archivePath),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.BackupRestoreRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Storage.BackupRestoreRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Storage.BackupRestoreRequest) return t;
...
$root.PB_System = (() => {
    ...
    return (
        (s.PingRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.PingRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.PingRequest) return t;
        ...
        (s.PingResponse = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.PingResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.PingResponse) return t;
        ...
        (s.RebootRequest = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.mode != null && Object.hasOwnProperty.call(t, 'mode') && e.uint32(8).int32(t.mode),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.RebootRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.RebootRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.mode = e.enums === String ? 'OS' : 0),
                        t.mode != null &&
                            t.hasOwnProperty('mode') &&
                            (i.mode = e.enums === String ? $root.PB_System.RebootRequest.RebootMode[t.mode] : t.mode),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.DeviceInfoRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.DeviceInfoRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
        ...
        (s.DeviceInfoResponse = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.key != null && Object.hasOwnProperty.call(t, 'key') && e.uint32(10).string(t.key),
                        t.value != null && Object.hasOwnProperty.call(t, 'value') && e.uint32(18).string(t.value),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.DeviceInfoResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.key != null && t.hasOwnProperty('key') && !$util.isString(t.key)
                          ? 'key: string expected'
                          : t.value != null && t.hasOwnProperty('value') && !$util.isString(t.value)
                            ? 'value: string expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.DeviceInfoResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && ((i.key = ''), (i.value = '')),
                        t.key != null && t.hasOwnProperty('key') && (i.key = t.key),
                        t.value != null && t.hasOwnProperty('value') && (i.value = t.value),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.FactoryResetRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.FactoryResetRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_System.FactoryResetRequest
                        ? t
                        : new $root.PB_System.FactoryResetRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.GetDateTimeRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.GetDateTimeRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_System.GetDateTimeRequest
                        ? t
                        : new $root.PB_System.GetDateTimeRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.GetDateTimeResponse = (function () {
            ...
            return (
                r(n, 'GetDateTimeResponse'),
                (n.prototype.datetime = null),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.datetime != null &&
                            Object.hasOwnProperty.call(t, 'datetime') &&
                            $root.PB_System.DateTime.encode(t.datetime, e.uint32(10).fork()).ldelim(),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.GetDateTimeResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    ...
                    if (t.datetime != null && t.hasOwnProperty('datetime')) {
                        ...
                        if (e) return 'datetime.' + e;
                    }
                    return null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.GetDateTimeResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.datetime = null),
                        t.datetime != null &&
                            t.hasOwnProperty('datetime') &&
                            (i.datetime = $root.PB_System.DateTime.toObject(t.datetime, e)),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.SetDateTimeRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.SetDateTimeRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.SetDateTimeRequest) return t;
        ...
        (s.DateTime = (function () {
            ...
            return (
                r(n, 'DateTime'),
                (n.prototype.hour = 0),
                (n.prototype.minute = 0),
                (n.prototype.second = 0),
                (n.prototype.day = 0),
                (n.prototype.month = 0),
                (n.prototype.year = 0),
                (n.prototype.weekday = 0),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.hour != null && Object.hasOwnProperty.call(t, 'hour') && e.uint32(8).uint32(t.hour),
                        t.minute != null && Object.hasOwnProperty.call(t, 'minute') && e.uint32(16).uint32(t.minute),
                        t.second != null && Object.hasOwnProperty.call(t, 'second') && e.uint32(24).uint32(t.second),
                        t.day != null && Object.hasOwnProperty.call(t, 'day') && e.uint32(32).uint32(t.day),
                        t.month != null && Object.hasOwnProperty.call(t, 'month') && e.uint32(40).uint32(t.month),
                        t.year != null && Object.hasOwnProperty.call(t, 'year') && e.uint32(48).uint32(t.year),
                        t.weekday != null && Object.hasOwnProperty.call(t, 'weekday') && e.uint32(56).uint32(t.weekday),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.hour != null && t.hasOwnProperty('hour') && !$util.isInteger(t.hour)
                          ? 'hour: integer expected'
                          : t.minute != null && t.hasOwnProperty('minute') && !$util.isInteger(t.minute)
                            ? 'minute: integer expected'
                            : t.second != null && t.hasOwnProperty('second') && !$util.isInteger(t.second)
                              ? 'second: integer expected'
                              : t.day != null && t.hasOwnProperty('day') && !$util.isInteger(t.day)
                                ? 'day: integer expected'
                                : t.month != null && t.hasOwnProperty('month') && !$util.isInteger(t.month)
                                  ? 'month: integer expected'
                                  : t.year != null && t.hasOwnProperty('year') && !$util.isInteger(t.year)
                                    ? 'year: integer expected'
                                    : t.weekday != null && t.hasOwnProperty('weekday') && !$util.isInteger(t.weekday)
                                      ? 'weekday: integer expected'
                                      : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.DateTime) return t;
                    const e = new $root.PB_System.DateTime();
                    return (
                        t.hour != null && (e.hour = t.hour >>> 0),
                        t.minute != null && (e.minute = t.minute >>> 0),
                        t.second != null && (e.second = t.second >>> 0),
                        t.day != null && (e.day = t.day >>> 0),
                        t.month != null && (e.month = t.month >>> 0),
                        t.year != null && (e.year = t.year >>> 0),
                        t.weekday != null && (e.weekday = t.weekday >>> 0),
                        e
                    );
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        e.defaults &&
                            ...
                            (i.year = 0),
                            (i.weekday = 0)),
                        t.hour != null && t.hasOwnProperty('hour') && (i.hour = t.hour),
                        t.minute != null && t.hasOwnProperty('minute') && (i.minute = t.minute),
                        t.second != null && t.hasOwnProperty('second') && (i.second = t.second),
                        t.day != null && t.hasOwnProperty('day') && (i.day = t.day),
                        t.month != null && t.hasOwnProperty('month') && (i.month = t.month),
                        t.year != null && t.hasOwnProperty('year') && (i.year = t.year),
                        t.weekday != null && t.hasOwnProperty('weekday') && (i.weekday = t.weekday),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.PlayAudiovisualAlertRequest = (function () {
            ...
            return (
                r(n, 'PlayAudiovisualAlertRequest'),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.PlayAudiovisualAlertRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_System.PlayAudiovisualAlertRequest
                        ? t
                        : new $root.PB_System.PlayAudiovisualAlertRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.ProtobufVersionRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.ProtobufVersionRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_System.ProtobufVersionRequest
                        ? t
                        : new $root.PB_System.ProtobufVersionRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.ProtobufVersionResponse = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.major != null && Object.hasOwnProperty.call(t, 'major') && e.uint32(8).uint32(t.major),
                        t.minor != null && Object.hasOwnProperty.call(t, 'minor') && e.uint32(16).uint32(t.minor),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.ProtobufVersionResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.major != null && t.hasOwnProperty('major') && !$util.isInteger(t.major)
                          ? 'major: integer expected'
                          : t.minor != null && t.hasOwnProperty('minor') && !$util.isInteger(t.minor)
                            ? 'minor: integer expected'
                            : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.ProtobufVersionResponse) return t;
                    const e = new $root.PB_System.ProtobufVersionResponse();
                    return (
                        t.major != null && (e.major = t.major >>> 0), t.minor != null && (e.minor = t.minor >>> 0), e
                    );
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    e || (e = {});
                    const i = {};
                    return (
                        e.defaults && ((i.major = 0), (i.minor = 0)),
                        t.major != null && t.hasOwnProperty('major') && (i.major = t.major),
                        t.minor != null && t.hasOwnProperty('minor') && (i.minor = t.minor),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.UpdateRequest = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.updateManifest != null &&
                            Object.hasOwnProperty.call(t, 'updateManifest') &&
                            e.uint32(10).string(t.updateManifest),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.UpdateRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.updateManifest != null &&
                            t.hasOwnProperty('updateManifest') &&
                            !$util.isString(t.updateManifest)
                          ? 'updateManifest: string expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.UpdateRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.updateManifest = ''),
                        t.updateManifest != null &&
                            t.hasOwnProperty('updateManifest') &&
                            (i.updateManifest = t.updateManifest),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.UpdateResponse = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.code != null && Object.hasOwnProperty.call(t, 'code') && e.uint32(8).int32(t.code),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.UpdateResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.UpdateResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.code = e.enums === String ? 'OK' : 0),
                        t.code != null &&
                            t.hasOwnProperty('code') &&
                            (i.code =
                                e.enums === String ? $root.PB_System.UpdateResponse.UpdateResultCode[t.code] : t.code),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
                ...
                (n.UpdateResultCode = (function () {
                    const o = {},
                        t = Object.create(o);
                    return (
                        (t[(o[0] = 'OK')] = 0),
                        (t[(o[1] = 'ManifestPathInvalid')] = 1),
                        (t[(o[2] = 'ManifestFolderNotFound')] = 2),
                        (t[(o[3] = 'ManifestInvalid')] = 3),
                        (t[(o[4] = 'StageMissing')] = 4),
                        (t[(o[5] = 'StageIntegrityError')] = 5),
                        (t[(o[6] = 'ManifestPointerError')] = 6),
                        (t[(o[7] = 'TargetMismatch')] = 7),
                        (t[(o[8] = 'OutdatedManifestVersion')] = 8),
                        (t[(o[9] = 'IntFull')] = 9),
                        (t[(o[10] = 'UnspecifiedError')] = 10),
                        t
                    );
                })()),
                n
        ...
        (s.PowerInfoRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.PowerInfoRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
        ...
        (s.PowerInfoResponse = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_System.PowerInfoResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_System.PowerInfoResponse) return t;
...
$root.PB_Gui = (() => {
    ...
    return (
        ...
        (s.ScreenOrientation = (function () {
            ...
            return (
                (o[(n[0] = 'HORIZONTAL')] = 0),
                (o[(n[1] = 'HORIZONTAL_FLIP')] = 1),
                (o[(n[2] = 'VERTICAL')] = 2),
                (o[(n[3] = 'VERTICAL_FLIP')] = 3),
                o
            );
        })()),
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        ...
                        t.data != null && Object.hasOwnProperty.call(t, 'data') && e.uint32(10).bytes(t.data),
                        t.orientation != null &&
                            Object.hasOwnProperty.call(t, 'orientation') &&
                            e.uint32(16).int32(t.orientation),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gui.ScreenFrame) return t;
                    ...
                    return (
                        e.defaults &&
                            (e.bytes === String
                                ? (i.data = '')
                                : ((i.data = []), e.bytes !== Array && (i.data = $util.newBuffer(i.data))),
                            (i.orientation = e.enums === String ? 'HORIZONTAL' : 0)),
                        t.data != null &&
                            t.hasOwnProperty('data') &&
                            (i.data =
                                e.bytes === String
                                    ...
                                    : e.bytes === Array
                                      ...
                                      : t.data),
                        t.orientation != null &&
                            t.hasOwnProperty('orientation') &&
                            (i.orientation =
                                e.enums === String ? $root.PB_Gui.ScreenOrientation[t.orientation] : t.orientation),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.StartScreenStreamRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gui.StartScreenStreamRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_Gui.StartScreenStreamRequest
                        ? t
                        : new $root.PB_Gui.StartScreenStreamRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.StopScreenStreamRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gui.StopScreenStreamRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_Gui.StopScreenStreamRequest
                        ? t
                        : new $root.PB_Gui.StopScreenStreamRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
        ...
        (s.SendInputEventRequest = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.key != null && Object.hasOwnProperty.call(t, 'key') && e.uint32(8).int32(t.key),
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gui.SendInputEventRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gui.SendInputEventRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        e.defaults &&
                            ((i.key = e.enums === String ? 'UP' : 0), (i.type = e.enums === String ? 'PRESS' : 0)),
                        t.key != null &&
                            t.hasOwnProperty('key') &&
                            (i.key = e.enums === String ? $root.PB_Gui.InputKey[t.key] : t.key),
                        t.type != null &&
                            t.hasOwnProperty('type') &&
                            (i.type = e.enums === String ? $root.PB_Gui.InputType[t.type] : t.type),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.StartVirtualDisplayRequest = (function () {
            ...
            return (
                r(n, 'StartVirtualDisplayRequest'),
                (n.prototype.firstFrame = null),
                (n.create = /* @__PURE__ */ r(function (t) {
                    return new n(t);
                }, 'create')),
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.firstFrame != null &&
                            Object.hasOwnProperty.call(t, 'firstFrame') &&
                            $root.PB_Gui.ScreenFrame.encode(t.firstFrame, e.uint32(10).fork()).ldelim(),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gui.StartVirtualDisplayRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    ...
                    if (t.firstFrame != null && t.hasOwnProperty('firstFrame')) {
                        ...
                        if (e) return 'firstFrame.' + e;
                    }
                    return null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gui.StartVirtualDisplayRequest) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.firstFrame = null),
                        t.firstFrame != null &&
                            t.hasOwnProperty('firstFrame') &&
                            (i.firstFrame = $root.PB_Gui.ScreenFrame.toObject(t.firstFrame, e)),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.StopVirtualDisplayRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gui.StopVirtualDisplayRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            default:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    return t instanceof $root.PB_Gui.StopVirtualDisplayRequest
                        ? t
                        : new $root.PB_Gui.StopVirtualDisplayRequest();
                }, 'fromObject')),
                (n.toObject = /* @__PURE__ */ r(function () {
                    return {};
                }, 'toObject')),
    ...
    return (
        ...
        (s.SetPinMode = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.pin != null && Object.hasOwnProperty.call(t, 'pin') && e.uint32(8).int32(t.pin),
                        t.mode != null && Object.hasOwnProperty.call(t, 'mode') && e.uint32(16).int32(t.mode),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.SetPinMode) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        e.defaults &&
                            ((i.pin = e.enums === String ? 'PC0' : 0), (i.mode = e.enums === String ? 'OUTPUT' : 0)),
                        t.pin != null &&
                            t.hasOwnProperty('pin') &&
                            (i.pin = e.enums === String ? $root.PB_Gpio.GpioPin[t.pin] : t.pin),
                        t.mode != null &&
                            t.hasOwnProperty('mode') &&
                            (i.mode = e.enums === String ? $root.PB_Gpio.GpioPinMode[t.mode] : t.mode),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        ...
                        t.pin != null && Object.hasOwnProperty.call(t, 'pin') && e.uint32(8).int32(t.pin),
                        t.pullMode != null &&
                            Object.hasOwnProperty.call(t, 'pullMode') &&
                            e.uint32(16).int32(t.pullMode),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gpio.SetInputPull();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.SetInputPull) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    return (
                        e.defaults &&
                            ((i.pin = e.enums === String ? 'PC0' : 0), (i.pullMode = e.enums === String ? 'NO' : 0)),
                        t.pin != null &&
                            t.hasOwnProperty('pin') &&
                            (i.pin = e.enums === String ? $root.PB_Gpio.GpioPin[t.pin] : t.pin),
                        t.pullMode != null &&
                            t.hasOwnProperty('pullMode') &&
                            (i.pullMode = e.enums === String ? $root.PB_Gpio.GpioInputPull[t.pullMode] : t.pullMode),
                        i
                    );
                }, 'toObject')),
                (n.prototype.toJSON = /* @__PURE__ */ r(function () {
        ...
        (s.GetPinMode = (function () {
            ...
            return (
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.GetPinMode) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.pin = e.enums === String ? 'PC0' : 0),
                        t.pin != null &&
                            t.hasOwnProperty('pin') &&
                            (i.pin = e.enums === String ? $root.PB_Gpio.GpioPin[t.pin] : t.pin),
                        i
        ...
        (s.GetPinModeResponse = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gpio.GetPinModeResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.GetPinModeResponse) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && (i.mode = e.enums === String ? 'OUTPUT' : 0),
                        t.mode != null &&
                            t.hasOwnProperty('mode') &&
                            (i.mode = e.enums === String ? $root.PB_Gpio.GpioPinMode[t.mode] : t.mode),
                        i
        ...
        (s.ReadPin = (function () {
            ...
            return (
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.ReadPin) return t;
        ...
        (s.ReadPinResponse = (function () {
            ...
            return (
                ...
                (n.encode = /* @__PURE__ */ r(function (t, e) {
                    return (
                        e || (e = $Writer.create()),
                        t.value != null && Object.hasOwnProperty.call(t, 'value') && e.uint32(16).uint32(t.value),
                        e
                    );
                }, 'encode')),
                (n.encodeDelimited = /* @__PURE__ */ r(function (t, e) {
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Gpio.ReadPinResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 2:
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    return typeof t != 'object' || t === null
                        ? 'object expected'
                        : t.value != null && t.hasOwnProperty('value') && !$util.isInteger(t.value)
                          ? 'value: integer expected'
                          : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.ReadPinResponse) return t;
        ...
        (s.WritePin = (function () {
            ...
            return (
                ...
                (n.verify = /* @__PURE__ */ r(function (t) {
                    ...
                    return t.value != null && t.hasOwnProperty('value') && !$util.isInteger(t.value)
                        ? 'value: integer expected'
                        : null;
                }, 'verify')),
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Gpio.WritePin) return t;
                ...
                (n.toObject = /* @__PURE__ */ r(function (t, e) {
                    ...
                    const i = {};
                    return (
                        e.defaults && ((i.pin = e.enums === String ? 'PC0' : 0), (i.value = 0)),
                        t.pin != null &&
                            t.hasOwnProperty('pin') &&
                            (i.pin = e.enums === String ? $root.PB_Gpio.GpioPin[t.pin] : t.pin),
                        t.value != null && t.hasOwnProperty('value') && (i.value = t.value),
        ...
        (s.GetRequest = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Property.GetRequest();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Property.GetRequest) return t;
        ...
        (s.GetResponse = (function () {
            ...
            return (
                ...
                (n.decode = /* @__PURE__ */ r(function (t, e) {
                    t instanceof $Reader || (t = $Reader.create(t));
                    const i = e === void 0 ? t.len : t.pos + e,
                        u = new $root.PB_Property.GetResponse();
                    for (; t.pos < i; ) {
                        const c = t.uint32();
                        switch (c >>> 3) {
                            case 1:
                ...
                (n.fromObject = /* @__PURE__ */ r(function (t) {
                    if (t instanceof $root.PB_Property.GetResponse) return t;
...
const S = class S {
    ...
    transform(n, o) {
        ...
        if (
            (t.set(this.chunks),
            t.set(n, this.chunks.length),
            (this.chunks = t),
            !this.rpcStarted &&
                this.decoder.decode(this.chunks) ===
                    `start_rpc_session\r
`)
        ) {
        ...
        try {
            const e = minimal.Reader.create(this.chunks),
                i = [];
            for (; e.pos < e.len; ) {
...
let ProtobufTransformer = S,
    createNanoEvents = /* @__PURE__ */ r(
        () => ({
            events: {},
            emit(s, ...n) {
            ...
            on(s, n) {
                return (
                    (this.events[s] = this.events[s] || []).push(n),
                    () => (this.events[s] = (this.events[s] || []).filter((o) => o !== n))
                );
            },
        }),
        'createNanoEvents'
...
function watch(s, n, o) {
    return {
        set: (e, i, u) => (
            (e[i] = u),
            typeof u == 'object' && (n && n.emit(o + '/progress', i), u.hasNext || (delete u.hasNext, s(e))),
            delete u.hasNext,
            !0
        ),
    };
...
function list({path: s}) {
    function n(o) {
        ...
        const e = t.findIndex((c) => c.type === 0),
            i = t.slice(0, e);
...
function deviceInfo() {
    function s(n) {
        const o = {};
        for (const t of n) o[t.key] = t.value;
        return o;
    }
...
function getDatetime() {
    function s(n) {
        let o = {};
        for (const t of n) o = {...o, ...t.datetime};
...
function update({path: s}) {
    ...
    return createRPCPromise.bind(this)('systemUpdateRequest', {updateManifest: s}, (o) =>
        Object.keys(n).find((t) => n[t] === o[0].code)
    );
}
r(update, 'update');
function powerInfo() {
...
const application = /* @__PURE__ */ Object.freeze(
        /* @__PURE__ */ Object.defineProperty(
            {
                __proto__: null,
                appButtonPress,
...
const gui = /* @__PURE__ */ Object.freeze(
        /* @__PURE__ */ Object.defineProperty(
            {
                __proto__: null,
                screenFrame,
...
r(writePin, 'writePin');
const gpio = /* @__PURE__ */ Object.freeze(
    /* @__PURE__ */ Object.defineProperty(
        {
            __proto__: null,
            getPinMode,
...
function mergeDeep(s, ...n) {
    ...
    if (isObject(s) && isObject(o))
        for (const t in o)
            isObject(o[t])
                ? (s[t] || Object.assign(s, {[t]: {}}), mergeDeep(s[t], o[t]))
                : Object.assign(s, {[t]: o[t]});
...
function get({key: s}) {
    function n(o) {
        const t = {};
        let e = {};
        for (const i of o) i.key && (t[i.key] = i.value);
...
r(get, 'get');
const property = /* @__PURE__ */ Object.freeze(
        /* @__PURE__ */ Object.defineProperty(
            {
                __proto__: null,
                get,
    ...
    m = class m {
        constructor({filters: n = [{usbVendorId: 1155, usbProductId: 22336}]} = {}) {
            (this.filters = n),
                (this.serialWorker = new Worker(
                    new URL('' + new URL('assets/serialWorker-34f93f49.js', import.meta.url).href, self.location)
                )),
                (this.serialWorker.onmessage = (o) => {
                    switch (o.data.message) {
                        case 'connectionStatus':
                            o.data.error
                                ? this.emitter.emit(o.data.operation + 'Status', o.data.error)
                                : o.data.status && this.emitter.emit(o.data.operation + 'Status', o.data.status);
                            break;
        ...
        getReader() {
            if (this.readingMode.type === 'text') {
                ...
                if (
                    ((this.readableStreamClosed = this.readable.pipeTo(n.writable)), this.readingMode.transform.length)
                ) {
                    let o;
                ...
                } else this.reader = n.readable.getReader();
                ...
                } else this.reader = this.readable.getReader();
            else throw new Error('Invalid reading mode');
            this.read();
        }
        async setReadingMode(n, o = '') {
            n &&
                ((this.readingMode.type = n),
                (this.readingMode.transform = o),
                this.reader.cancel(),
                this.readableStreamClosed && (await this.readableStreamClosed.catch(() => {})),
        ...
        async connect() {
            ...
            return new Promise((o, t) => {
                this.serialWorker.postMessage({message: 'connect'}),
                    setTimeout(() => t('Serial connection timeout'), RPC_TIMEOUT);
        ...
        encodeRPCRequest(n, o, t, e) {
            ...
            if (
                ((u[n] = o || {}),
                e
                    ? ((u.commandId = e), (i = this.commandQueue.find((a) => a.commandId === u.commandId)))
                    : (u.commandId = this.commandQueue.length),
                !i)
            ) {
